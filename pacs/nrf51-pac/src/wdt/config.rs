...
pub enum SLEEP_A {
    #[doc = "0: Pause watchdog while the CPU is asleep."]
    PAUSE = 0,
    #[doc = "1: Do not pause watchdog while the CPU is asleep."]
    RUN = 1,
}
...
#[doc = "Field `SLEEP` reader - Configure the watchdog to pause or not while the CPU is sleeping."]
...
#[doc = "Field `SLEEP` writer - Configure the watchdog to pause or not while the CPU is sleeping."]
...
pub enum HALT_A {
    ...
    PAUSE = 0,
    #[doc = "1: Do not pause watchdog while the CPU is halted by the debugger."]
    RUN = 1,
}
...
#[doc = "Field `HALT` reader - Configure the watchdog to pause or not while the CPU is halted by the debugger."]
...
#[doc = "Field `HALT` writer - Configure the watchdog to pause or not while the CPU is halted by the debugger."]
pub struct HALT_W<'a> {
    w: &'a mut W,
}
impl<'a> HALT_W<'a> {
