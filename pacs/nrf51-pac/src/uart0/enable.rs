...
#[doc = "Field `ENABLE` reader - Enable or disable UART and acquire IOs."]
...
#[doc = "Field `ENABLE` writer - Enable or disable UART and acquire IOs."]
pub type ENABLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ENABLE_SPEC, u8, ENABLE_A, 3, O>;
