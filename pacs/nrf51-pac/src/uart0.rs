...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn pselrts(&self) -> &Pselrts {
        &self.pselrts
    }
    #[doc = "0x50c - Pin select for TXD."]
    #[inline(always)]
    pub const fn pseltxd(&self) -> &Pseltxd {
        &self.pseltxd
    }
    #[doc = "0x510 - Pin select for CTS."]
    #[inline(always)]
    pub const fn pselcts(&self) -> &Pselcts {
        &self.pselcts
    }
    #[doc = "0x514 - Pin select for RXD."]
    #[inline(always)]
    pub const fn pselrxd(&self) -> &Pselrxd {
        &self.pselrxd
    }
...
pub mod intenclr;
#[doc = "ERRORSRC (rw) register accessor: Error source. Write error field to 1 to clear error.\n\nYou can [`read`](crate::Reg::read) this register and get [`errorsrc::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`errorsrc::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@errorsrc`] module"]
#[doc(alias = "ERRORSRC")]
pub type Errorsrc = crate::Reg<errorsrc::ErrorsrcSpec>;
#[doc = "Error source. Write error field to 1 to clear error."]
pub mod errorsrc;
#[doc = "ENABLE (rw) register accessor: Enable UART and acquire IOs.\n\nYou can [`read`](crate::Reg::read) this register and get [`enable::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`enable::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@enable`] module"]
#[doc(alias = "ENABLE")]
pub type Enable = crate::Reg<enable::EnableSpec>;
#[doc = "Enable UART and acquire IOs."]
pub mod enable;
#[doc = "PSELRTS (rw) register accessor: Pin select for RTS.\n\nYou can [`read`](crate::Reg::read) this register and get [`pselrts::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pselrts::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pselrts`] module"]
#[doc(alias = "PSELRTS")]
pub type Pselrts = crate::Reg<pselrts::PselrtsSpec>;
#[doc = "Pin select for RTS."]
pub mod pselrts;
#[doc = "PSELTXD (rw) register accessor: Pin select for TXD.\n\nYou can [`read`](crate::Reg::read) this register and get [`pseltxd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pseltxd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pseltxd`] module"]
#[doc(alias = "PSELTXD")]
pub type Pseltxd = crate::Reg<pseltxd::PseltxdSpec>;
#[doc = "Pin select for TXD."]
pub mod pseltxd;
#[doc = "PSELCTS (rw) register accessor: Pin select for CTS.\n\nYou can [`read`](crate::Reg::read) this register and get [`pselcts::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pselcts::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pselcts`] module"]
#[doc(alias = "PSELCTS")]
pub type Pselcts = crate::Reg<pselcts::PselctsSpec>;
#[doc = "Pin select for CTS."]
pub mod pselcts;
#[doc = "PSELRXD (rw) register accessor: Pin select for RXD.\n\nYou can [`read`](crate::Reg::read) this register and get [`pselrxd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pselrxd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pselrxd`] module"]
#[doc(alias = "PSELRXD")]
pub type Pselrxd = crate::Reg<pselrxd::PselrxdSpec>;
#[doc = "Pin select for RXD."]
pub mod pselrxd;
#[doc = "RXD (r) register accessor: RXD register. On read action the buffer pointer is displaced. Once read the character is consumed. If read when no character available, the UART will stop working.\n\nYou can [`read`](crate::Reg::read) this register and get [`rxd::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\n<div class=\"warning\">One or more dependent resources other than the current register are immediately affected by a read operation.</div>\n\nFor information about available fields see [`mod@rxd`] module"]
#[doc(alias = "RXD")]
