...
impl RegisterBlock {
    ...
    #[doc = "0x40..0x50 - Capture Timer value to CC\\[n\\] registers."]
    #[inline(always)]
    ...
    #[doc = "0x140..0x150 - Compare event on CC\\[n\\] match."]
    #[inline(always)]
