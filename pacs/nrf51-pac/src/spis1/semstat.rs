...
pub enum SEMSTAT_A {
    ...
    FREE = 0,
    #[doc = "1: Semaphore is assigned to the CPU."]
    CPU = 1,
    #[doc = "2: Semaphore is assigned to the SPIS."]
    SPIS = 2,
    #[doc = "3: Semaphore is assigned to the SPIS, but a handover to the CPU is pending."]
    CPUPENDING = 3,
}
