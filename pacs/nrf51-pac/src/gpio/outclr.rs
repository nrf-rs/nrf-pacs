...
pub type Pin0W<'a, REG> = crate::BitWriter<'a, REG, Pin0WO>;
...
pub type Pin1W<'a, REG> = crate::BitWriter<'a, REG, Pin1WO>;
...
pub type Pin2W<'a, REG> = crate::BitWriter<'a, REG, Pin2WO>;
...
pub type Pin3W<'a, REG> = crate::BitWriter<'a, REG, Pin3WO>;
...
pub type Pin4W<'a, REG> = crate::BitWriter<'a, REG, Pin4WO>;
...
pub type Pin5W<'a, REG> = crate::BitWriter<'a, REG, Pin5WO>;
...
pub type Pin6W<'a, REG> = crate::BitWriter<'a, REG, Pin6WO>;
...
pub type Pin7W<'a, REG> = crate::BitWriter<'a, REG, Pin7WO>;
...
pub type Pin8W<'a, REG> = crate::BitWriter<'a, REG, Pin8WO>;
...
pub type Pin9W<'a, REG> = crate::BitWriter<'a, REG, Pin9WO>;
...
pub type Pin10W<'a, REG> = crate::BitWriter<'a, REG, Pin10WO>;
...
pub type Pin11W<'a, REG> = crate::BitWriter<'a, REG, Pin11WO>;
...
pub type Pin12W<'a, REG> = crate::BitWriter<'a, REG, Pin12WO>;
...
pub type Pin13W<'a, REG> = crate::BitWriter<'a, REG, Pin13WO>;
...
pub type Pin14W<'a, REG> = crate::BitWriter<'a, REG, Pin14WO>;
...
pub type Pin15W<'a, REG> = crate::BitWriter<'a, REG, Pin15WO>;
...
pub type Pin16W<'a, REG> = crate::BitWriter<'a, REG, Pin16WO>;
...
pub type Pin17W<'a, REG> = crate::BitWriter<'a, REG, Pin17WO>;
...
pub type Pin18W<'a, REG> = crate::BitWriter<'a, REG, Pin18WO>;
...
pub type Pin19W<'a, REG> = crate::BitWriter<'a, REG, Pin19WO>;
...
pub type Pin20W<'a, REG> = crate::BitWriter<'a, REG, Pin20WO>;
...
pub type Pin21W<'a, REG> = crate::BitWriter<'a, REG, Pin21WO>;
...
pub type Pin22W<'a, REG> = crate::BitWriter<'a, REG, Pin22WO>;
...
pub type Pin23W<'a, REG> = crate::BitWriter<'a, REG, Pin23WO>;
...
pub type Pin24W<'a, REG> = crate::BitWriter<'a, REG, Pin24WO>;
...
pub type Pin25W<'a, REG> = crate::BitWriter<'a, REG, Pin25WO>;
...
pub type Pin26W<'a, REG> = crate::BitWriter<'a, REG, Pin26WO>;
...
pub type Pin27W<'a, REG> = crate::BitWriter<'a, REG, Pin27WO>;
...
pub type Pin28W<'a, REG> = crate::BitWriter<'a, REG, Pin28WO>;
...
pub type Pin29W<'a, REG> = crate::BitWriter<'a, REG, Pin29WO>;
...
pub type Pin30W<'a, REG> = crate::BitWriter<'a, REG, Pin30WO>;
...
pub type Pin31W<'a, REG> = crate::BitWriter<'a, REG, Pin31WO>;
...
impl W {
    #[doc = "Bit 0 - Pin 0."]
    #[inline(always)]
    pub fn pin0(&mut self) -> Pin0W<'_, OutclrSpec> {
        Pin0W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin 1."]
    #[inline(always)]
    pub fn pin1(&mut self) -> Pin1W<'_, OutclrSpec> {
        Pin1W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin 2."]
    #[inline(always)]
    pub fn pin2(&mut self) -> Pin2W<'_, OutclrSpec> {
        Pin2W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin 3."]
    #[inline(always)]
    pub fn pin3(&mut self) -> Pin3W<'_, OutclrSpec> {
        Pin3W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin 4."]
    #[inline(always)]
    pub fn pin4(&mut self) -> Pin4W<'_, OutclrSpec> {
        Pin4W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin 5."]
    #[inline(always)]
    pub fn pin5(&mut self) -> Pin5W<'_, OutclrSpec> {
        Pin5W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin 6."]
    #[inline(always)]
    pub fn pin6(&mut self) -> Pin6W<'_, OutclrSpec> {
        Pin6W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin 7."]
    #[inline(always)]
    pub fn pin7(&mut self) -> Pin7W<'_, OutclrSpec> {
        Pin7W::new(self, 7)
    }
    #[doc = "Bit 8 - Pin 8."]
    #[inline(always)]
    pub fn pin8(&mut self) -> Pin8W<'_, OutclrSpec> {
        Pin8W::new(self, 8)
    }
    #[doc = "Bit 9 - Pin 9."]
    #[inline(always)]
    pub fn pin9(&mut self) -> Pin9W<'_, OutclrSpec> {
        Pin9W::new(self, 9)
    }
    #[doc = "Bit 10 - Pin 10."]
    #[inline(always)]
    pub fn pin10(&mut self) -> Pin10W<'_, OutclrSpec> {
        Pin10W::new(self, 10)
    }
    #[doc = "Bit 11 - Pin 11."]
    #[inline(always)]
    pub fn pin11(&mut self) -> Pin11W<'_, OutclrSpec> {
        Pin11W::new(self, 11)
    }
    #[doc = "Bit 12 - Pin 12."]
    #[inline(always)]
    pub fn pin12(&mut self) -> Pin12W<'_, OutclrSpec> {
        Pin12W::new(self, 12)
    }
    #[doc = "Bit 13 - Pin 13."]
    #[inline(always)]
    pub fn pin13(&mut self) -> Pin13W<'_, OutclrSpec> {
        Pin13W::new(self, 13)
    }
    #[doc = "Bit 14 - Pin 14."]
    #[inline(always)]
    pub fn pin14(&mut self) -> Pin14W<'_, OutclrSpec> {
        Pin14W::new(self, 14)
    }
    #[doc = "Bit 15 - Pin 15."]
    #[inline(always)]
    pub fn pin15(&mut self) -> Pin15W<'_, OutclrSpec> {
        Pin15W::new(self, 15)
    }
    #[doc = "Bit 16 - Pin 16."]
    #[inline(always)]
    pub fn pin16(&mut self) -> Pin16W<'_, OutclrSpec> {
        Pin16W::new(self, 16)
    }
    #[doc = "Bit 17 - Pin 17."]
    #[inline(always)]
    pub fn pin17(&mut self) -> Pin17W<'_, OutclrSpec> {
        Pin17W::new(self, 17)
    }
    #[doc = "Bit 18 - Pin 18."]
    #[inline(always)]
    pub fn pin18(&mut self) -> Pin18W<'_, OutclrSpec> {
        Pin18W::new(self, 18)
    }
    #[doc = "Bit 19 - Pin 19."]
    #[inline(always)]
    pub fn pin19(&mut self) -> Pin19W<'_, OutclrSpec> {
        Pin19W::new(self, 19)
    }
    #[doc = "Bit 20 - Pin 20."]
    #[inline(always)]
    pub fn pin20(&mut self) -> Pin20W<'_, OutclrSpec> {
        Pin20W::new(self, 20)
    }
    #[doc = "Bit 21 - Pin 21."]
    #[inline(always)]
    pub fn pin21(&mut self) -> Pin21W<'_, OutclrSpec> {
        Pin21W::new(self, 21)
    }
    #[doc = "Bit 22 - Pin 22."]
    #[inline(always)]
    pub fn pin22(&mut self) -> Pin22W<'_, OutclrSpec> {
        Pin22W::new(self, 22)
    }
    #[doc = "Bit 23 - Pin 23."]
    #[inline(always)]
    pub fn pin23(&mut self) -> Pin23W<'_, OutclrSpec> {
        Pin23W::new(self, 23)
    }
    #[doc = "Bit 24 - Pin 24."]
    #[inline(always)]
    pub fn pin24(&mut self) -> Pin24W<'_, OutclrSpec> {
        Pin24W::new(self, 24)
    }
    #[doc = "Bit 25 - Pin 25."]
    #[inline(always)]
    pub fn pin25(&mut self) -> Pin25W<'_, OutclrSpec> {
        Pin25W::new(self, 25)
    }
    #[doc = "Bit 26 - Pin 26."]
    #[inline(always)]
    pub fn pin26(&mut self) -> Pin26W<'_, OutclrSpec> {
        Pin26W::new(self, 26)
    }
    #[doc = "Bit 27 - Pin 27."]
    #[inline(always)]
    pub fn pin27(&mut self) -> Pin27W<'_, OutclrSpec> {
        Pin27W::new(self, 27)
    }
    #[doc = "Bit 28 - Pin 28."]
    #[inline(always)]
    pub fn pin28(&mut self) -> Pin28W<'_, OutclrSpec> {
        Pin28W::new(self, 28)
    }
    #[doc = "Bit 29 - Pin 29."]
    #[inline(always)]
    pub fn pin29(&mut self) -> Pin29W<'_, OutclrSpec> {
        Pin29W::new(self, 29)
    }
    #[doc = "Bit 30 - Pin 30."]
    #[inline(always)]
    pub fn pin30(&mut self) -> Pin30W<'_, OutclrSpec> {
        Pin30W::new(self, 30)
    }
    #[doc = "Bit 31 - Pin 31."]
    #[inline(always)]
    pub fn pin31(&mut self) -> Pin31W<'_, OutclrSpec> {
        Pin31W::new(self, 31)
    }
}
