...
#[doc = "Field `LEDPRE` reader - Period in us the LED in switched on prior to sampling."]
...
#[doc = "Field `LEDPRE` writer - Period in us the LED in switched on prior to sampling."]
