...
#[doc = "Field `COMPARE0` reader - Disable routing to PPI of COMPARE\\[0\\] event."]
...
#[doc = "Field `COMPARE0` writer - Disable routing to PPI of COMPARE\\[0\\] event."]
...
#[doc = "Field `COMPARE1` reader - Disable routing to PPI of COMPARE\\[1\\] event."]
...
#[doc = "Field `COMPARE1` writer - Disable routing to PPI of COMPARE\\[1\\] event."]
...
#[doc = "Field `COMPARE2` reader - Disable routing to PPI of COMPARE\\[2\\] event."]
...
#[doc = "Field `COMPARE2` writer - Disable routing to PPI of COMPARE\\[2\\] event."]
...
#[doc = "Field `COMPARE3` reader - Disable routing to PPI of COMPARE\\[3\\] event."]
...
#[doc = "Field `COMPARE3` writer - Disable routing to PPI of COMPARE\\[3\\] event."]
