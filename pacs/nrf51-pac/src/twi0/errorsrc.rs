...
pub type ANACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ERRORSRC_SPEC, ANACK_AW, O>;
...
pub type DNACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ERRORSRC_SPEC, DNACK_AW, O>;
