...
pub struct RegisterBlock {
    ...
    _reserved11: [u8; 0x2c],
    subscribe_capture: [SubscribeCapture; 6],
    _reserved12: [u8; 0x68],
    events_compare: [EventsCompare; 6],
    _reserved13: [u8; 0x68],
    publish_compare: [PublishCompare; 6],
    _reserved14: [u8; 0x28],
    shorts: Shorts,
...
impl RegisterBlock {
    ...
    #[doc = "0x40..0x58 - Description collection: Capture Timer value to CC\\[n\\] register"]
    #[inline(always)]
    ...
    #[doc = "0x140..0x158 - Description collection: Compare event on CC\\[n\\] match"]
    #[inline(always)]
    ...
    #[doc = "0x514..0x52c - Description collection: Enable one-shot operation for Capture/Compare channel n"]
    #[inline(always)]
