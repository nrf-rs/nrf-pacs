...
#[doc = "Field `CHIDX` reader - Channel that event CH\\[n\\].LIMITL will publish to."]
pub type CHIDX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CHIDX` writer - Channel that event CH\\[n\\].LIMITL will publish to."]
pub type CHIDX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LIMITL_SPEC, u8, u8, 4, O>;
#[doc = "Field `EN` reader - "]
...
#[doc = "Field `EN` writer - "]
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LIMITL_SPEC, EN_A, O>;
...
impl R {
    #[doc = "Bits 0:3 - Channel that event CH\\[n\\].LIMITL will publish to."]
    #[inline(always)]
