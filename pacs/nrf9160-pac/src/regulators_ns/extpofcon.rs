...
impl W {
    #[doc = "Bit 0 - Enable or disable external power failure warning"]
    #[inline(always)]
    pub fn pof(&mut self) -> PofW<'_, ExtpofconSpec> {
        PofW::new(self, 0)
    }
}
#[doc = "External power failure warning configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`extpofcon::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`extpofcon::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
