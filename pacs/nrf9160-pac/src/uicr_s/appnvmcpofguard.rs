...
impl W {
    #[doc = "Bit 0 - Enable blocking NVM WRITE and aborting NVM ERASE in POFWARN condition"]
    #[inline(always)]
    pub fn nvmcpofguarden(&mut self) -> NvmcpofguardenW<'_, AppnvmcpofguardSpec> {
        NvmcpofguardenW::new(self, 0)
    }
}
#[doc = "Enable blocking NVM WRITE and aborting NVM ERASE for Application NVM in POFWARN condition.\n\nYou can [`read`](crate::Reg::read) this register and get [`appnvmcpofguard::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`appnvmcpofguard::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
