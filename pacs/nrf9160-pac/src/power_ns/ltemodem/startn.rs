...
impl W {
    #[doc = "Bit 0 - Start LTE modem"]
    #[inline(always)]
    pub fn startn(&mut self) -> StartnW<'_, StartnSpec> {
        StartnW::new(self, 0)
    }
}
#[doc = "Start LTE modem\n\nYou can [`read`](crate::Reg::read) this register and get [`startn::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`startn::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
