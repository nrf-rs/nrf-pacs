...
#[doc = "Field `SECUREMAPPING` writer - Define configuration capabilities for TrustZone Cortex-M secure attribute"]
pub type SECUREMAPPING_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PERM_SPEC, u8, SECUREMAPPING_A, 2, O>;
impl<'a, const O: u8> SECUREMAPPING_W<'a, O> {
    #[doc = "The bus access from this external domain always have the non-secure attribute set"]
    #[inline(always)]
    pub fn non_secure(self) -> &'a mut W {
        self.variant(SECUREMAPPING_A::NON_SECURE)
    }
    ...
    pub fn user_selectable(self) -> &'a mut W {
        self.variant(SECUREMAPPING_A::USER_SELECTABLE)
    }
}
...
impl W {
    #[doc = "Bits 0:1 - Define configuration capabilities for TrustZone Cortex-M secure attribute"]
    #[inline(always)]
    pub fn securemapping(&mut self) -> SECUREMAPPING_W<0> {
        SECUREMAPPING_W::new(self)
    }
    #[doc = "Bit 4 - Peripheral security mapping"]
    #[inline(always)]
