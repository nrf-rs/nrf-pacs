...
#[doc = "Field `CHIDX` reader - Channel that event COMPARE\\[n\\]
will publish to."]
pub type CHIDX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CHIDX` writer - Channel that event COMPARE\\[n\\]
will publish to."]
pub type CHIDX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PUBLISH_COMPARE_SPEC, u8, u8, 4, O>;
#[doc = "Field `EN` reader - "]
...
impl R {
    #[doc = "Bits 0:3 - Channel that event COMPARE\\[n\\]
will publish to."]
    #[inline(always)]
