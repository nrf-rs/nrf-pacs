...
pub type R = crate::R<Tracedata1Spec>;
#[doc = "Register `TRACEDATA1` writer"]
pub type W = crate::W<Tracedata1Spec>;
#[doc = "Pin number\n\nValue on reset: 31"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Pin {
    #[doc = "23: TRACEDATA1 pin"]
    Tracedata1 = 23,
}
    ...
    REG::Ux: From<u8>,
{
    #[doc = "TRACEDATA1 pin"]
    #[inline(always)]
    pub fn tracedata1(self) -> &'a mut crate::W<REG> {
        self.variant(Pin::Tracedata1)
    }
}
#[doc = "Connection\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<'_, Tracedata1Spec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<'_, Tracedata1Spec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin configuration for TRACEDATA\\[1\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`tracedata1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tracedata1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tracedata1Spec;
impl crate::RegisterSpec for Tracedata1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tracedata1::R`](R) reader structure"]
impl crate::Readable for Tracedata1Spec {}
#[doc = "`write(|w| ..)` method takes [`tracedata1::W`](W) writer structure"]
impl crate::Writable for Tracedata1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TRACEDATA1 to value 0xffff_ffff"]
impl crate::Resettable for Tracedata1Spec {
