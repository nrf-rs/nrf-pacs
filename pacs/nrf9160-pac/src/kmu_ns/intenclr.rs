...
pub type KEYSLOT_PUSHED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTENCLR_SPEC, KEYSLOT_PUSHED_AW, O>;
...
pub type KEYSLOT_REVOKED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTENCLR_SPEC, KEYSLOT_REVOKED_AW, O>;
...
pub type KEYSLOT_ERROR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTENCLR_SPEC, KEYSLOT_ERROR_AW, O>;
