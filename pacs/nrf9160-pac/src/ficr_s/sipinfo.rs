...
impl Sipinfo {
    ...
    #[doc = "0x04 - Description collection: SIP hardware revision, encoded in ASCII, for example B0A or B1A"]
    #[inline(always)]
    ...
    #[doc = "0x08 - Description collection: SIP VARIANT, encoded in ASCII, for example SIAA, SIBA or SICA. See Ordering information for details."]
    #[inline(always)]
...
#[doc = "PARTNO (r) register accessor: SIP part number\n\nYou can [`read`](crate::Reg::read) this register and get [`partno::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@partno`] module"]
#[doc(alias = "PARTNO")]
pub type Partno = crate::Reg<partno::PartnoSpec>;
#[doc = "SIP part number"]
pub mod partno;
#[doc = "HWREVISION (r) register accessor: Description collection: SIP hardware revision, encoded in ASCII, for example B0A or B1A\n\nYou can [`read`](crate::Reg::read) this register and get [`hwrevision::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@hwrevision`] module"]
