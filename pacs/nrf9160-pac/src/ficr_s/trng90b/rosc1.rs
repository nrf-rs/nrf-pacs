...
#[doc = "Field `ROSC1` reader - Sample count for ring oscillator configuration 1"]
pub type Rosc1R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Sample count for ring oscillator configuration 1"]
    #[inline(always)]
    pub fn rosc1(&self) -> Rosc1R {
        Rosc1R::new(self.bits)
    }
}
#[doc = "Sample count for ring oscillator configuration 1\n\nYou can [`read`](crate::Reg::read) this register and get [`rosc1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
