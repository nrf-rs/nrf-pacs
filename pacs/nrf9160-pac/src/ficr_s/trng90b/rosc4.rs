...
#[doc = "Field `ROSC4` reader - Sample count for ring oscillator configuration 4"]
pub type Rosc4R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Sample count for ring oscillator configuration 4"]
    #[inline(always)]
    pub fn rosc4(&self) -> Rosc4R {
        Rosc4R::new(self.bits)
    }
}
#[doc = "Sample count for ring oscillator configuration 4\n\nYou can [`read`](crate::Reg::read) this register and get [`rosc4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
