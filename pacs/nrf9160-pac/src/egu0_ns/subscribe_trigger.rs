...
#[doc = "Field `CHIDX` reader - DPPI channel that task TRIGGER\\[n\\] will subscribe to"]
pub type ChidxR = crate::FieldReader;
#[doc = "Field `CHIDX` writer - DPPI channel that task TRIGGER\\[n\\] will subscribe to"]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that task TRIGGER\\[n\\] will subscribe to"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that task TRIGGER\\[n\\] will subscribe to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, SubscribeTriggerSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
