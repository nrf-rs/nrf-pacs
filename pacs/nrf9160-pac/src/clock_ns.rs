...
impl RegisterBlock {
    ...
    #[doc = "0x518 - Clock source for the LFCLK. LFCLKSTART task starts a clock source selected with this register."]
    #[inline(always)]
