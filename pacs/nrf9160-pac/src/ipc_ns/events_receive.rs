...
#[doc = "Field `EVENTS_RECEIVE` reader - Event received on one or more of the enabled channels in RECEIVE_CNF\\[n\\]."]
...
#[doc = "Field `EVENTS_RECEIVE` writer - Event received on one or more of the enabled channels in RECEIVE_CNF\\[n\\]."]
