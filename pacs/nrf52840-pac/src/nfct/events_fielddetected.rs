...
#[doc = "Field `EVENTS_FIELDDETECTED` reader - "]
pub type EVENTS_FIELDDETECTED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_FIELDDETECTED` writer - "]
pub type EVENTS_FIELDDETECTED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_FIELDDETECTED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
