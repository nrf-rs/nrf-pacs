...
#[doc = "Field `EVENTS_TXDRDY` reader - "]
pub type EVENTS_TXDRDY_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_TXDRDY` writer - "]
pub type EVENTS_TXDRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_TXDRDY_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
