...
#[doc = "Field `EVENTS_TXSTOPPED` reader - "]
pub type EVENTS_TXSTOPPED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_TXSTOPPED` writer - "]
pub type EVENTS_TXSTOPPED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_TXSTOPPED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
