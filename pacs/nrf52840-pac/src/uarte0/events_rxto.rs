...
#[doc = "Field `EVENTS_RXTO` reader - "]
pub type EVENTS_RXTO_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_RXTO` writer - "]
pub type EVENTS_RXTO_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_RXTO_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
