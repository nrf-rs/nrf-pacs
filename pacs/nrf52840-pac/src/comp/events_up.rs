...
#[doc = "Field `EVENTS_UP` reader - "]
pub type EVENTS_UP_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_UP` writer - "]
pub type EVENTS_UP_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_UP_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
