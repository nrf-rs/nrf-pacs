...
#[doc = "Field `EVENTS_ENDRX` reader - "]
pub type EVENTS_ENDRX_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_ENDRX` writer - "]
pub type EVENTS_ENDRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_ENDRX_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
