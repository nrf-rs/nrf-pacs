...
#[doc = "Field `EVENTS_ENDTX` reader - "]
pub type EVENTS_ENDTX_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_ENDTX` writer - "]
pub type EVENTS_ENDTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_ENDTX_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
