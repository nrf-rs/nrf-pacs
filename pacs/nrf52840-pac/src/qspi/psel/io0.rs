...
pub type R = crate::R<Io0Spec>;
#[doc = "Register `IO0` writer"]
pub type W = crate::W<Io0Spec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<'_, Io0Spec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<'_, Io0Spec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<'_, Io0Spec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for serial data MOSI/IO0.\n\nYou can [`read`](crate::Reg::read) this register and get [`io0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Io0Spec;
impl crate::RegisterSpec for Io0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io0::R`](R) reader structure"]
impl crate::Readable for Io0Spec {}
#[doc = "`write(|w| ..)` method takes [`io0::W`](W) writer structure"]
impl crate::Writable for Io0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IO0 to value 0xffff_ffff"]
impl crate::Resettable for Io0Spec {
