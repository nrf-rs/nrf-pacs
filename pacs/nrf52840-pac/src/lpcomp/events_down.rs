...
#[doc = "Field `EVENTS_DOWN` reader - "]
pub type EVENTS_DOWN_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_DOWN` writer - "]
pub type EVENTS_DOWN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_DOWN_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
