...
#[doc = "Field `RXPTRUPD` reader - Write '1' to disable interrupt for RXPTRUPD event"]
...
#[doc = "Field `RXPTRUPD` writer - Write '1' to disable interrupt for RXPTRUPD event"]
...
#[doc = "Field `TXPTRUPD` reader - Write '1' to disable interrupt for TXPTRUPD event"]
...
#[doc = "Field `TXPTRUPD` writer - Write '1' to disable interrupt for TXPTRUPD event"]
