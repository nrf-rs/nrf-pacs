...
#[doc = "Field `TICK` reader - Write '1' to disable event routing for TICK event"]
...
#[doc = "Field `TICK` writer - Write '1' to disable event routing for TICK event"]
...
#[doc = "Field `OVRFLW` reader - Write '1' to disable event routing for OVRFLW event"]
...
#[doc = "Field `OVRFLW` writer - Write '1' to disable event routing for OVRFLW event"]
...
#[doc = "Field `COMPARE0` reader - Write '1' to disable event routing for COMPARE\\[0\\]
event"]
pub type COMPARE0_R = crate::BitReader<COMPARE0_A>;
#[doc = "Write '1' to disable event routing for COMPARE\\[0\\]
event\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMPARE0_A {
    #[doc = "0: Read: Disabled"]
...
#[doc = "Field `COMPARE0` writer - Write '1' to disable event routing for COMPARE\\[0\\]
event"]
...
#[doc = "Field `COMPARE1` reader - Write '1' to disable event routing for COMPARE\\[1\\]
event"]
pub type COMPARE1_R = crate::BitReader<COMPARE1_A>;
#[doc = "Write '1' to disable event routing for COMPARE\\[1\\]
event\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMPARE1_A {
    #[doc = "0: Read: Disabled"]
...
#[doc = "Field `COMPARE1` writer - Write '1' to disable event routing for COMPARE\\[1\\]
event"]
...
#[doc = "Field `COMPARE2` reader - Write '1' to disable event routing for COMPARE\\[2\\]
event"]
pub type COMPARE2_R = crate::BitReader<COMPARE2_A>;
#[doc = "Write '1' to disable event routing for COMPARE\\[2\\]
event\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMPARE2_A {
    #[doc = "0: Read: Disabled"]
...
#[doc = "Field `COMPARE2` writer - Write '1' to disable event routing for COMPARE\\[2\\]
event"]
...
#[doc = "Field `COMPARE3` reader - Write '1' to disable event routing for COMPARE\\[3\\]
event"]
pub type COMPARE3_R = crate::BitReader<COMPARE3_A>;
#[doc = "Write '1' to disable event routing for COMPARE\\[3\\]
event\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMPARE3_A {
    #[doc = "0: Read: Disabled"]
...
#[doc = "Field `COMPARE3` writer - Write '1' to disable event routing for COMPARE\\[3\\]
event"]
...
impl R {
    ...
    #[doc = "Bit 16 - Write '1' to disable event routing for COMPARE\\[0\\]
event"]
    #[inline(always)]
    pub fn compare0(&self) -> COMPARE0_R {
        COMPARE0_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Write '1' to disable event routing for COMPARE\\[1\\]
event"]
    #[inline(always)]
    pub fn compare1(&self) -> COMPARE1_R {
        COMPARE1_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - Write '1' to disable event routing for COMPARE\\[2\\]
event"]
    #[inline(always)]
    pub fn compare2(&self) -> COMPARE2_R {
        COMPARE2_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - Write '1' to disable event routing for COMPARE\\[3\\]
event"]
    #[inline(always)]
