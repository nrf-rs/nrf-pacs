...
#[doc = "Field `EVENTS_TICK` reader - "]
pub type EVENTS_TICK_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_TICK` writer - "]
pub type EVENTS_TICK_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_TICK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
