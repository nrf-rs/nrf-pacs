...
#[doc = "Field `EVENTS_CRCERROR` reader - "]
pub type EVENTS_CRCERROR_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_CRCERROR` writer - "]
pub type EVENTS_CRCERROR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_CRCERROR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
