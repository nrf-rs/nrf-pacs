...
#[doc = "Field `EVENTS_EDSTOPPED` reader - "]
pub type EVENTS_EDSTOPPED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_EDSTOPPED` writer - "]
pub type EVENTS_EDSTOPPED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_EDSTOPPED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
