...
#[doc = "Field `EVENTS_DEVMISS` reader - "]
pub type EVENTS_DEVMISS_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_DEVMISS` writer - "]
pub type EVENTS_DEVMISS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_DEVMISS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
