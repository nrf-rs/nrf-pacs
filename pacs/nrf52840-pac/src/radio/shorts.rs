...
#[doc = "Field `READY_START` writer - Shortcut between READY event and START task"]
...
#[doc = "Field `END_DISABLE` writer - Shortcut between END event and DISABLE task"]
...
#[doc = "Field `DISABLED_TXEN` writer - Shortcut between DISABLED event and TXEN task"]
...
#[doc = "Field `DISABLED_RXEN` writer - Shortcut between DISABLED event and RXEN task"]
...
#[doc = "Field `ADDRESS_RSSISTART` writer - Shortcut between ADDRESS event and RSSISTART task"]
...
#[doc = "Field `END_START` writer - Shortcut between END event and START task"]
...
#[doc = "Field `ADDRESS_BCSTART` writer - Shortcut between ADDRESS event and BCSTART task"]
...
#[doc = "Field `DISABLED_RSSISTOP` writer - Shortcut between DISABLED event and RSSISTOP task"]
...
#[doc = "Field `RXREADY_CCASTART` reader - Shortcut between RXREADY event and CCASTART task"]
...
#[doc = "Field `RXREADY_CCASTART` writer - Shortcut between RXREADY event and CCASTART task"]
...
#[doc = "Field `CCAIDLE_TXEN` reader - Shortcut between CCAIDLE event and TXEN task"]
...
#[doc = "Field `CCAIDLE_TXEN` writer - Shortcut between CCAIDLE event and TXEN task"]
...
#[doc = "Field `CCABUSY_DISABLE` reader - Shortcut between CCABUSY event and DISABLE task"]
...
#[doc = "Field `CCABUSY_DISABLE` writer - Shortcut between CCABUSY event and DISABLE task"]
...
#[doc = "Field `FRAMESTART_BCSTART` reader - Shortcut between FRAMESTART event and BCSTART task"]
...
#[doc = "Field `FRAMESTART_BCSTART` writer - Shortcut between FRAMESTART event and BCSTART task"]
...
#[doc = "Field `READY_EDSTART` reader - Shortcut between READY event and EDSTART task"]
...
#[doc = "Field `READY_EDSTART` writer - Shortcut between READY event and EDSTART task"]
...
#[doc = "Field `EDEND_DISABLE` reader - Shortcut between EDEND event and DISABLE task"]
...
#[doc = "Field `EDEND_DISABLE` writer - Shortcut between EDEND event and DISABLE task"]
...
#[doc = "Field `CCAIDLE_STOP` reader - Shortcut between CCAIDLE event and STOP task"]
...
#[doc = "Field `CCAIDLE_STOP` writer - Shortcut between CCAIDLE event and STOP task"]
...
#[doc = "Field `TXREADY_START` reader - Shortcut between TXREADY event and START task"]
...
#[doc = "Field `TXREADY_START` writer - Shortcut between TXREADY event and START task"]
...
#[doc = "Field `RXREADY_START` reader - Shortcut between RXREADY event and START task"]
...
#[doc = "Field `RXREADY_START` writer - Shortcut between RXREADY event and START task"]
...
#[doc = "Field `PHYEND_DISABLE` reader - Shortcut between PHYEND event and DISABLE task"]
...
#[doc = "Field `PHYEND_DISABLE` writer - Shortcut between PHYEND event and DISABLE task"]
...
#[doc = "Field `PHYEND_START` reader - Shortcut between PHYEND event and START task"]
...
#[doc = "Field `PHYEND_START` writer - Shortcut between PHYEND event and START task"]
