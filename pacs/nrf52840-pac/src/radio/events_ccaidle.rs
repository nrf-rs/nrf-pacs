...
#[doc = "Field `EVENTS_CCAIDLE` reader - "]
pub type EVENTS_CCAIDLE_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_CCAIDLE` writer - "]
pub type EVENTS_CCAIDLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_CCAIDLE_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
