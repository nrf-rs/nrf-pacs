...
#[doc = "Field `EVENTS_ADDRESS` reader - "]
pub type EVENTS_ADDRESS_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_ADDRESS` writer - "]
pub type EVENTS_ADDRESS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_ADDRESS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
