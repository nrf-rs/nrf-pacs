...
#[doc = "Field `EVENTS_RSSIEND` reader - "]
pub type EVENTS_RSSIEND_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_RSSIEND` writer - "]
pub type EVENTS_RSSIEND_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_RSSIEND_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
