...
#[doc = "Field `EVENTS_BCMATCH` reader - "]
pub type EVENTS_BCMATCH_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_BCMATCH` writer - "]
pub type EVENTS_BCMATCH_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_BCMATCH_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
