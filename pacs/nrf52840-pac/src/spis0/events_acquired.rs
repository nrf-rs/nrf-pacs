...
#[doc = "Field `EVENTS_ACQUIRED` reader - "]
pub type EVENTS_ACQUIRED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_ACQUIRED` writer - "]
pub type EVENTS_ACQUIRED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_ACQUIRED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
