...
#[doc = "Field `SEQEND0_STOP` reader - Shortcut between event SEQEND\\[0\\] and task STOP"]
...
#[doc = "Field `SEQEND0_STOP` writer - Shortcut between event SEQEND\\[0\\] and task STOP"]
...
#[doc = "Field `SEQEND1_STOP` reader - Shortcut between event SEQEND\\[1\\] and task STOP"]
...
#[doc = "Field `SEQEND1_STOP` writer - Shortcut between event SEQEND\\[1\\] and task STOP"]
...
impl R {
    #[doc = "Bit 0 - Shortcut between event SEQEND\\[0\\] and task STOP"]
    #[inline(always)]
    pub fn seqend0_stop(&self) -> Seqend0StopR {
        Seqend0StopR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Shortcut between event SEQEND\\[1\\] and task STOP"]
    #[inline(always)]
