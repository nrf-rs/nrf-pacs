...
#[doc = "Field `EVENTS_SEQEND` reader - "]
pub type EVENTS_SEQEND_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_SEQEND` writer - "]
pub type EVENTS_SEQEND_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_SEQEND_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
