...
#[doc = "Field `EVENTS_RXDRDY` reader - "]
pub type EVENTS_RXDRDY_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_RXDRDY` writer - "]
pub type EVENTS_RXDRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_RXDRDY_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
