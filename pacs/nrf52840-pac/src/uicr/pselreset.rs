...
#[doc = "Field `PIN` reader - Pin number of PORT onto which nRESET is exposed"]
pub type PIN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PIN` writer - Pin number of PORT onto which nRESET is exposed"]
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PSELRESET_SPEC, u8, u8, 5, O>;
...
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSELRESET_SPEC, bool, O>;
...
impl R {
    #[doc = "Bits 0:4 - Pin number of PORT onto which nRESET is exposed"]
    #[inline(always)]
