...
#[doc = "Field `CTSTARTED` reader - Write '1' to disable interrupt for CTSTARTED event"]
...
#[doc = "Field `CTSTARTED` writer - Write '1' to disable interrupt for CTSTARTED event"]
pub type CTSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, CTSTARTED_AW, O>;
...
#[doc = "Field `CTSTOPPED` reader - Write '1' to disable interrupt for CTSTOPPED event"]
...
#[doc = "Field `CTSTOPPED` writer - Write '1' to disable interrupt for CTSTOPPED event"]
pub type CTSTOPPED_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, CTSTOPPED_AW, O>;
