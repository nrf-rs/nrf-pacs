...
#[doc = "Field `EVENTS_CTSTOPPED` reader - "]
pub type EVENTS_CTSTOPPED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_CTSTOPPED` writer - "]
pub type EVENTS_CTSTOPPED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_CTSTOPPED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
