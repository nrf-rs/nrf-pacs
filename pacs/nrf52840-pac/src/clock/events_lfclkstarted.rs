...
#[doc = "Field `EVENTS_LFCLKSTARTED` reader - "]
pub type EVENTS_LFCLKSTARTED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_LFCLKSTARTED` writer - "]
pub type EVENTS_LFCLKSTARTED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_LFCLKSTARTED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
