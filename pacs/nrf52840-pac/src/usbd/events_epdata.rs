...
#[doc = "Field `EVENTS_EPDATA` reader - "]
pub type EVENTS_EPDATA_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_EPDATA` writer - "]
pub type EVENTS_EPDATA_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVENTS_EPDATA_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
