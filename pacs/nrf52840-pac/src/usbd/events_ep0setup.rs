...
#[doc = "Field `EVENTS_EP0SETUP` reader - "]
pub type EVENTS_EP0SETUP_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_EP0SETUP` writer - "]
pub type EVENTS_EP0SETUP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_EP0SETUP_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
