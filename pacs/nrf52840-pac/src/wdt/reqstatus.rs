...
pub enum Rr0 {
    #[doc = "0: RR\\[0\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[0\\] register is enabled, and is not yet requesting reload"]
...
impl Rr0R {
    ...
    #[doc = "RR\\[0\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr0::DisabledOrRequested
    }
    #[doc = "RR\\[0\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr1 {
    #[doc = "0: RR\\[1\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[1\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr1R {
    ...
    #[doc = "RR\\[1\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr1::DisabledOrRequested
    }
    #[doc = "RR\\[1\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr2 {
    #[doc = "0: RR\\[2\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[2\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr2R {
    ...
    #[doc = "RR\\[2\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr2::DisabledOrRequested
    }
    #[doc = "RR\\[2\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr3 {
    #[doc = "0: RR\\[3\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[3\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr3R {
    ...
    #[doc = "RR\\[3\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr3::DisabledOrRequested
    }
    #[doc = "RR\\[3\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr4 {
    #[doc = "0: RR\\[4\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[4\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr4R {
    ...
    #[doc = "RR\\[4\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr4::DisabledOrRequested
    }
    #[doc = "RR\\[4\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr5 {
    #[doc = "0: RR\\[5\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[5\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr5R {
    ...
    #[doc = "RR\\[5\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr5::DisabledOrRequested
    }
    #[doc = "RR\\[5\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr6 {
    #[doc = "0: RR\\[6\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[6\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr6R {
    ...
    #[doc = "RR\\[6\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr6::DisabledOrRequested
    }
    #[doc = "RR\\[6\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rr7 {
    #[doc = "0: RR\\[7\\] register is not enabled, or is already requesting reload"]
    DisabledOrRequested = 0,
    #[doc = "1: RR\\[7\\] register is enabled, and is not yet requesting reload"]
    EnabledAndUnrequested = 1,
}
...
impl Rr7R {
    ...
    #[doc = "RR\\[7\\] register is not enabled, or is already requesting reload"]
    #[inline(always)]
    pub fn is_disabled_or_requested(&self) -> bool {
        *self == Rr7::DisabledOrRequested
    }
    #[doc = "RR\\[7\\] register is enabled, and is not yet requesting reload"]
    #[inline(always)]
    pub fn is_enabled_and_unrequested(&self) -> bool {
