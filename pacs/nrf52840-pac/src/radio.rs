...
pub struct RegisterBlock {
    ...
    _reserved63: [u8; 0x9c],
    #[doc = "0x600..0x620 - Description collection\\[n\\]: Device address base segment n"]
    pub dab: [crate::Reg<dab::DAB_SPEC>; 8],
    #[doc = "0x620..0x640 - Description collection\\[n\\]: Device address prefix n"]
