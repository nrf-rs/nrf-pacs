...
impl Info {
    ...
    #[doc = "0x04 - Build code, last two letters of Package Variant and first two characters of Build Code, encoded in ASCII."]
    #[inline(always)]
