...
impl W {
    #[doc = "Bit 7 - Shortcut between event LASTTX and task STARTRX"]
    #[inline(always)]
    pub fn lasttx_startrx(&mut self) -> LasttxStartrxW<'_, ShortsSpec> {
    ...
    #[doc = "Bit 10 - Shortcut between event LASTRX and task STARTTX"]
    #[inline(always)]
    pub fn lastrx_starttx(&mut self) -> LastrxStarttxW<'_, ShortsSpec> {
        LastrxStarttxW::new(self, 10)
    }
    #[doc = "Bit 11 - Shortcut between event LASTRX and task SUSPEND"]
    #[inline(always)]
    pub fn lastrx_suspend(&mut self) -> LastrxSuspendW<'_, ShortsSpec> {
