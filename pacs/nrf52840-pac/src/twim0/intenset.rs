...
#[doc = "Write '1' to enable interrupt for LASTRX event\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LASTRX_A {
    #[doc = "0: Read: Disabled"]
    DISABLED = 0,
...
#[doc = "Field `LASTRX` writer - Write '1' to enable interrupt for LASTRX event"]
...
#[doc = "Write '1' to enable interrupt for LASTTX event\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LASTTX_A {
    #[doc = "0: Read: Disabled"]
    DISABLED = 0,
...
#[doc = "Field `LASTTX` writer - Write '1' to enable interrupt for LASTTX event"]
