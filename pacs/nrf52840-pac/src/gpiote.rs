...
pub struct RegisterBlock {
    #[doc = "0x00..0x20 - Description collection\\[n\\]: Task for writing to pin specified in CONFIG\\[n\\].PSEL. Action on pin is configured in CONFIG\\[n\\].POLARITY."]
    pub tasks_out: [crate::Reg<tasks_out::TASKS_OUT_SPEC>; 8],
    _reserved1: [u8; 0x10],
    #[doc = "0x30..0x50 - Description collection\\[n\\]: Task for writing to pin specified in CONFIG\\[n\\].PSEL. Action on pin is to set it high."]
    pub tasks_set: [crate::Reg<tasks_set::TASKS_SET_SPEC>; 8],
    _reserved2: [u8; 0x10],
    #[doc = "0x60..0x80 - Description collection\\[n\\]: Task for writing to pin specified in CONFIG\\[n\\].PSEL. Action on pin is to set it low."]
    pub tasks_clr: [crate::Reg<tasks_clr::TASKS_CLR_SPEC>; 8],
    _reserved3: [u8; 0x80],
    #[doc = "0x100..0x120 - Description collection\\[n\\]: Event generated from pin specified in CONFIG\\[n\\].PSEL"]
    ...
    #[doc = "0x510..0x530 - Description collection\\[n\\]: Configuration for OUT\\[n\\], SET\\[n\\]
and CLR\\[n\\]
tasks and IN\\[n\\]
event"]
...
#[doc = "Description collection\\[n\\]: Configuration for OUT\\[n\\], SET\\[n\\]
and CLR\\[n\\]
tasks and IN\\[n\\]
event"]
pub mod config;
