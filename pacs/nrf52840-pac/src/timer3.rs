...
pub struct RegisterBlock {
    ...
    _reserved5: [u8; 0x2c],
    #[doc = "0x40..0x58 - Description collection\\[n\\]: Capture Timer value to CC\\[n\\]
register"]
    pub tasks_capture: [TASKS_CAPTURE; 6],
    _reserved6: [u8; 0xe8],
    #[doc = "0x140..0x158 - Description collection\\[n\\]: Compare event on CC\\[n\\]
match"]
    ...
    _reserved13: [u8; 0x2c],
    #[doc = "0x540..0x558 - Description collection\\[n\\]: Capture/Compare register n"]
    pub cc: [CC; 6],
}
