...
#[doc = "Field `SIZE` reader - Size of flash region n in bytes. Must be a multiple of the flash page size, and the maximum region size is limited to 512kB."]
...
#[doc = "Field `SIZE` writer - Size of flash region n in bytes. Must be a multiple of the flash page size, and the maximum region size is limited to 512kB."]
pub struct SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> SIZE_W<'a> {
