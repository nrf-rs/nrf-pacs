...
pub struct RegisterBlock {
    #[doc = "0x00..0x40 - Description collection\\[n\\]: Trigger n for triggering the corresponding TRIGGERED\\[n\\]
event"]
    pub tasks_trigger: [TASKS_TRIGGER; 16],
    _reserved1: [u8; 0xc0],
    #[doc = "0x100..0x140 - Description collection\\[n\\]: Event number n generated by triggering the corresponding TRIGGER\\[n\\]
task"]
