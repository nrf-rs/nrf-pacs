...
#[doc = "Field `EVENTS_SLEEPEXIT` reader - "]
pub type EVENTS_SLEEPEXIT_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_SLEEPEXIT` writer - "]
pub type EVENTS_SLEEPEXIT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_SLEEPEXIT_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
