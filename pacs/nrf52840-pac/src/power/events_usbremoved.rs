...
#[doc = "Field `EVENTS_USBREMOVED` reader - "]
pub type EVENTS_USBREMOVED_R = crate::BitReader<bool>;
#[doc = "Field `EVENTS_USBREMOVED` writer - "]
pub type EVENTS_USBREMOVED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_USBREMOVED_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
