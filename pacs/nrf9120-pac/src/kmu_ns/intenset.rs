...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn keyslot_pushed(&mut self) -> KeyslotPushedW<IntensetSpec> {
        KeyslotPushedW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to enable interrupt for event KEYSLOT_REVOKED"]
    #[inline(always)]
    #[must_use]
    pub fn keyslot_revoked(&mut self) -> KeyslotRevokedW<IntensetSpec> {
        KeyslotRevokedW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to enable interrupt for event KEYSLOT_ERROR"]
    #[inline(always)]
    #[must_use]
    pub fn keyslot_error(&mut self) -> KeyslotErrorW<IntensetSpec> {
