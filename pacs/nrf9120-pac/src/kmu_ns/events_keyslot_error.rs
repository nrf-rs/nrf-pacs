...
impl W {
    #[doc = "Bit 0 - No key slot selected, no destination address defined, or error during push operation"]
    #[inline(always)]
    pub fn events_keyslot_error(&mut self) -> EventsKeyslotErrorW<'_, EventsKeyslotErrorSpec> {
        EventsKeyslotErrorW::new(self, 0)
    }
}
#[doc = "No key slot selected, no destination address defined, or error during push operation\n\nYou can [`read`](crate::Reg::read) this register and get [`events_keyslot_error::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`events_keyslot_error::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
