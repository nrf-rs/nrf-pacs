...
impl W {
    #[doc = "Bit 0 - Key slot successfully pushed over secure APB"]
    #[inline(always)]
    pub fn events_keyslot_pushed(&mut self) -> EventsKeyslotPushedW<'_, EventsKeyslotPushedSpec> {
        EventsKeyslotPushedW::new(self, 0)
    }
}
#[doc = "Key slot successfully pushed over secure APB\n\nYou can [`read`](crate::Reg::read) this register and get [`events_keyslot_pushed::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`events_keyslot_pushed::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
