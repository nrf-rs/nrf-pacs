...
pub type R = crate::R<TrcauthstatusSpec>;
#[doc = "Register `TRCAUTHSTATUS` writer"]
pub type W = crate::W<TrcauthstatusSpec>;
...
impl W {
    #[doc = "Bits 0:1 - Non-secure Invasive Debug"]
    #[inline(always)]
    pub fn nsid(&mut self) -> NsidW<'_, TrcauthstatusSpec> {
        NsidW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Non-secure Non-Invasive Debug"]
    #[inline(always)]
    pub fn nsnid(&mut self) -> NsnidW<'_, TrcauthstatusSpec> {
        NsnidW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Secure Invasive Debug"]
    #[inline(always)]
    pub fn sid(&mut self) -> SidW<'_, TrcauthstatusSpec> {
        SidW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Secure Non-Invasive Debug"]
    #[inline(always)]
    pub fn snid(&mut self) -> SnidW<'_, TrcauthstatusSpec> {
        SnidW::new(self, 6)
    }
}
...
pub struct TrcauthstatusSpec;
impl crate::RegisterSpec for TrcauthstatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trcauthstatus::R`](R) reader structure"]
impl crate::Readable for TrcauthstatusSpec {}
#[doc = "`write(|w| ..)` method takes [`trcauthstatus::W`](W) writer structure"]
impl crate::Writable for TrcauthstatusSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TRCAUTHSTATUS to value 0"]
impl crate::Resettable for TrcauthstatusSpec {}
