...
impl RegisterBlock {
    #[doc = "0x70 - Request forcing PWM mode in PMIC DC/DC buck regulator. (Drives FPWM_DCDC pin high or low depending on a setting in UICR)."]
    #[inline(always)]
    pub const fn tasks_pwmreqstart(&self) -> &TasksPwmreqstart {
        &self.tasks_pwmreqstart
    }
    #[doc = "0x74 - Stop requesting forcing PWM mode in PMIC DC/DC buck regulator"]
    #[inline(always)]
...
#[doc = "TASKS_PWMREQSTART (w) register accessor: Request forcing PWM mode in PMIC DC/DC buck regulator. (Drives FPWM_DCDC pin high or low depending on a setting in UICR).\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tasks_pwmreqstart::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tasks_pwmreqstart`] module"]
#[doc(alias = "TASKS_PWMREQSTART")]
pub type TasksPwmreqstart = crate::Reg<tasks_pwmreqstart::TasksPwmreqstartSpec>;
#[doc = "Request forcing PWM mode in PMIC DC/DC buck regulator. (Drives FPWM_DCDC pin high or low depending on a setting in UICR)."]
pub mod tasks_pwmreqstart;
#[doc = "TASKS_PWMREQSTOP (w) register accessor: Stop requesting forcing PWM mode in PMIC DC/DC buck regulator\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tasks_pwmreqstop::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tasks_pwmreqstop`] module"]
...
#[doc = "SUBSCRIBE_PWMREQSTART (rw) register accessor: Subscribe configuration for task PWMREQSTART\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_pwmreqstart::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_pwmreqstart::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@subscribe_pwmreqstart`] module"]
...
#[doc = "SUBSCRIBE_PWMREQSTOP (rw) register accessor: Subscribe configuration for task PWMREQSTOP\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_pwmreqstop::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_pwmreqstop::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@subscribe_pwmreqstop`] module"]
...
#[doc = "Reset reason"]
pub mod resetreas;
#[doc = "POWERSTATUS (r) register accessor: Modem domain power status\n\nYou can [`read`](crate::Reg::read) this register and get [`powerstatus::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@powerstatus`] module"]
