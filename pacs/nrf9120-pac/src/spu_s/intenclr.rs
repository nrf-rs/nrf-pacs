    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(RamaccerrWO::Clear)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(FlashaccerrWO::Clear)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ramaccerr(&mut self) -> RamaccerrW<IntenclrSpec> {
        RamaccerrW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event FLASHACCERR"]
    #[inline(always)]
    #[must_use]
    pub fn flashaccerr(&mut self) -> FlashaccerrW<IntenclrSpec> {
        FlashaccerrW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event PERIPHACCERR"]
    #[inline(always)]
    #[must_use]
    pub fn periphaccerr(&mut self) -> PeriphaccerrW<IntenclrSpec> {
