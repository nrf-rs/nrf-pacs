...
impl W {
    #[doc = "Bit 0 - A security violation has been detected for the flash memory space"]
    #[inline(always)]
    pub fn events_flashaccerr(&mut self) -> EventsFlashaccerrW<'_, EventsFlashaccerrSpec> {
        EventsFlashaccerrW::new(self, 0)
    }
}
#[doc = "A security violation has been detected for the flash memory space\n\nYou can [`read`](crate::Reg::read) this register and get [`events_flashaccerr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`events_flashaccerr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
