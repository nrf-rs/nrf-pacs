...
impl W {
    #[doc = "Bits 0:5 - Pierce current DAC control signals"]
    #[inline(always)]
    pub fn ctrl(&mut self) -> CtrlW<'_, Xosc32mSpec> {
        CtrlW::new(self, 0)
    }
}
#[doc = "Oscillator control\n\nYou can [`read`](crate::Reg::read) this register and get [`xosc32m::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`xosc32m::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
