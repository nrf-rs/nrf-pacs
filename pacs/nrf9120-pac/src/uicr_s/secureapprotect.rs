...
impl W {
    #[doc = "Bits 0:31 - Blocks debugger read/write access to all secure CPU registers and secure memory mapped addresses"]
    #[inline(always)]
    pub fn pall(&mut self) -> PallW<'_, SecureapprotectSpec> {
        PallW::new(self, 0)
    }
}
#[doc = "Secure access port protection\n\nYou can [`read`](crate::Reg::read) this register and get [`secureapprotect::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`secureapprotect::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets SECUREAPPROTECT to value 0xffff_ffff"]
