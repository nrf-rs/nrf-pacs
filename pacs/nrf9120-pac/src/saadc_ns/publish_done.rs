...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chidx(&mut self) -> ChidxW<PublishDoneSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<PublishDoneSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Publish configuration for event DONE\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`publish_done::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`publish_done::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
