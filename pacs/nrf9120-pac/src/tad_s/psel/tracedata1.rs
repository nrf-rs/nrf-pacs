...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRACEDATA1_SPEC, u8, PIN_A, 5, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRACEDATA1_SPEC, CONNECT_A, O>;
