...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin(&mut self) -> PinW<Tracedata1Spec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    #[must_use]
    pub fn connect(&mut self) -> ConnectW<Tracedata1Spec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin configuration for TRACEDATA\\[1\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tracedata1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tracedata1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
