...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn receive0(&mut self) -> Receive0W<IntensetSpec> {
        Receive0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to enable interrupt for event RECEIVE\\[1\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive1(&mut self) -> Receive1W<IntensetSpec> {
        Receive1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to enable interrupt for event RECEIVE\\[2\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive2(&mut self) -> Receive2W<IntensetSpec> {
        Receive2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to enable interrupt for event RECEIVE\\[3\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive3(&mut self) -> Receive3W<IntensetSpec> {
        Receive3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to enable interrupt for event RECEIVE\\[4\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive4(&mut self) -> Receive4W<IntensetSpec> {
        Receive4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to enable interrupt for event RECEIVE\\[5\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive5(&mut self) -> Receive5W<IntensetSpec> {
        Receive5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to enable interrupt for event RECEIVE\\[6\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive6(&mut self) -> Receive6W<IntensetSpec> {
        Receive6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to enable interrupt for event RECEIVE\\[7\\]"]
    #[inline(always)]
    #[must_use]
    pub fn receive7(&mut self) -> Receive7W<IntensetSpec> {
