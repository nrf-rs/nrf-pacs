...
pub mod detectmode;
#[doc = "DETECTMODE_SEC (rw) register accessor: Select between default DETECT signal behavior and LDETECT mode (For secure pin only)\n\nYou can [`read`](crate::Reg::read) this register and get [`detectmode_sec::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`detectmode_sec::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@detectmode_sec`] module"]
