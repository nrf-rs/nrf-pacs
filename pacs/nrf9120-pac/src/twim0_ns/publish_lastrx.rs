...
pub type R = crate::R<PublishLastrxSpec>;
#[doc = "Register `PUBLISH_LASTRX` writer"]
pub type W = crate::W<PublishLastrxSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chidx(&mut self) -> ChidxW<PublishLastrxSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<PublishLastrxSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Publish configuration for event LASTRX\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`publish_lastrx::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`publish_lastrx::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PublishLastrxSpec;
impl crate::RegisterSpec for PublishLastrxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`publish_lastrx::R`](R) reader structure"]
impl crate::Readable for PublishLastrxSpec {}
#[doc = "`write(|w| ..)` method takes [`publish_lastrx::W`](W) writer structure"]
impl crate::Writable for PublishLastrxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PUBLISH_LASTRX to value 0"]
impl crate::Resettable for PublishLastrxSpec {
