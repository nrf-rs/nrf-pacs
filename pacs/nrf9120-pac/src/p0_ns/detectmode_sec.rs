...
impl W {
    #[doc = "Bit 0 - Select between default DETECT signal behavior and LDETECT mode"]
    #[inline(always)]
    pub fn detectmode(&mut self) -> DetectmodeW<'_, DetectmodeSecSpec> {
        DetectmodeW::new(self, 0)
    }
}
#[doc = "Select between default DETECT signal behavior and LDETECT mode (For secure pin only)\n\nYou can [`read`](crate::Reg::read) this register and get [`detectmode_sec::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`detectmode_sec::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
