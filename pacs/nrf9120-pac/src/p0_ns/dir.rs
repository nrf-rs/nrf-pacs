...
impl W {
    ...
    #[doc = "Bit 16 - Pin 16"]
    #[inline(always)]
    pub fn pin16(&mut self) -> Pin16W<'_, DirSpec> {
        Pin16W::new(self, 16)
    }
    #[doc = "Bit 17 - Pin 17"]
    #[inline(always)]
    pub fn pin17(&mut self) -> Pin17W<'_, DirSpec> {
        Pin17W::new(self, 17)
    }
    #[doc = "Bit 18 - Pin 18"]
    #[inline(always)]
    pub fn pin18(&mut self) -> Pin18W<'_, DirSpec> {
        Pin18W::new(self, 18)
    }
    #[doc = "Bit 19 - Pin 19"]
    #[inline(always)]
    pub fn pin19(&mut self) -> Pin19W<'_, DirSpec> {
        Pin19W::new(self, 19)
    }
    #[doc = "Bit 20 - Pin 20"]
    #[inline(always)]
    pub fn pin20(&mut self) -> Pin20W<'_, DirSpec> {
        Pin20W::new(self, 20)
    }
    #[doc = "Bit 21 - Pin 21"]
    #[inline(always)]
    pub fn pin21(&mut self) -> Pin21W<'_, DirSpec> {
        Pin21W::new(self, 21)
    }
    #[doc = "Bit 22 - Pin 22"]
    #[inline(always)]
    pub fn pin22(&mut self) -> Pin22W<'_, DirSpec> {
        Pin22W::new(self, 22)
    }
    #[doc = "Bit 23 - Pin 23"]
    #[inline(always)]
    pub fn pin23(&mut self) -> Pin23W<'_, DirSpec> {
        Pin23W::new(self, 23)
    }
    #[doc = "Bit 24 - Pin 24"]
    #[inline(always)]
    pub fn pin24(&mut self) -> Pin24W<'_, DirSpec> {
        Pin24W::new(self, 24)
    }
    #[doc = "Bit 25 - Pin 25"]
    #[inline(always)]
    pub fn pin25(&mut self) -> Pin25W<'_, DirSpec> {
        Pin25W::new(self, 25)
    }
    #[doc = "Bit 26 - Pin 26"]
    #[inline(always)]
    pub fn pin26(&mut self) -> Pin26W<'_, DirSpec> {
        Pin26W::new(self, 26)
    }
    #[doc = "Bit 27 - Pin 27"]
    #[inline(always)]
    pub fn pin27(&mut self) -> Pin27W<'_, DirSpec> {
        Pin27W::new(self, 27)
    }
    #[doc = "Bit 28 - Pin 28"]
    #[inline(always)]
    pub fn pin28(&mut self) -> Pin28W<'_, DirSpec> {
        Pin28W::new(self, 28)
    }
    #[doc = "Bit 29 - Pin 29"]
    #[inline(always)]
    pub fn pin29(&mut self) -> Pin29W<'_, DirSpec> {
        Pin29W::new(self, 29)
    }
    #[doc = "Bit 30 - Pin 30"]
    #[inline(always)]
    pub fn pin30(&mut self) -> Pin30W<'_, DirSpec> {
        Pin30W::new(self, 30)
    }
    #[doc = "Bit 31 - Pin 31"]
    #[inline(always)]
    pub fn pin31(&mut self) -> Pin31W<'_, DirSpec> {
        Pin31W::new(self, 31)
    }
}
