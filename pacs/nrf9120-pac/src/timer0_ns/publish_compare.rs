...
#[doc = "Field `CHIDX` reader - DPPI channel that event COMPARE\\[n\\] will publish to"]
pub type ChidxR = crate::FieldReader;
#[doc = "Field `CHIDX` writer - DPPI channel that event COMPARE\\[n\\] will publish to"]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that event COMPARE\\[n\\] will publish to"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that event COMPARE\\[n\\] will publish to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, PublishCompareSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, PublishCompareSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Description collection: Publish configuration for event COMPARE\\[n\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_compare::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_compare::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets PUBLISH_COMPARE[%s] to value 0"]
