...
#[doc = "SUBSCRIBE_ACQUIRE (rw) register accessor: an alias for `Reg<SUBSCRIBE_ACQUIRE_SPEC>`"]
...
#[doc = "SUBSCRIBE_RELEASE (rw) register accessor: an alias for `Reg<SUBSCRIBE_RELEASE_SPEC>`"]
...
#[doc = "PUBLISH_ACQUIRED (rw) register accessor: an alias for `Reg<PUBLISH_ACQUIRED_SPEC>`"]
