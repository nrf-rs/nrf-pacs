...
pub type R = crate::R<SubscribeResumeSpec>;
#[doc = "Register `SUBSCRIBE_RESUME` writer"]
pub type W = crate::W<SubscribeResumeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chidx(&mut self) -> ChidxW<SubscribeResumeSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<SubscribeResumeSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Subscribe configuration for task RESUME\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`subscribe_resume::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`subscribe_resume::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SubscribeResumeSpec;
impl crate::RegisterSpec for SubscribeResumeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`subscribe_resume::R`](R) reader structure"]
impl crate::Readable for SubscribeResumeSpec {}
#[doc = "`write(|w| ..)` method takes [`subscribe_resume::W`](W) writer structure"]
impl crate::Writable for SubscribeResumeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SUBSCRIBE_RESUME to value 0"]
impl crate::Resettable for SubscribeResumeSpec {
