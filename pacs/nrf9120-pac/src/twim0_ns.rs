...
#[doc = "PUBLISH_SUSPENDED (rw) register accessor: an alias for `Reg<PUBLISH_SUSPENDED_SPEC>`"]
...
#[doc = "PUBLISH_LASTRX (rw) register accessor: an alias for `Reg<PUBLISH_LASTRX_SPEC>`"]
...
#[doc = "PUBLISH_LASTTX (rw) register accessor: an alias for `Reg<PUBLISH_LASTTX_SPEC>`"]
