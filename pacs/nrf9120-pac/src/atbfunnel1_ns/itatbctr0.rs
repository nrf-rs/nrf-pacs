...
#[doc = "Field `ATVALID` reader - A read returns the value of the atvalids\\[n\\] signal, where the value of the CTRLREG at 0x000 defines n. A write outputs the value to atvalidm."]
...
#[doc = "Field `ATVALID` writer - A read returns the value of the atvalids\\[n\\] signal, where the value of the CTRLREG at 0x000 defines n. A write outputs the value to atvalidm."]
...
#[doc = "Field `AFREADY` reader - A read returns the value of the afreadys\\[n\\] signal, where the value of the Ctrl_Reg at 0x000 defines n. A write outputs the value to afreadym."]
...
#[doc = "Field `AFREADY` writer - A read returns the value of the afreadys\\[n\\] signal, where the value of the Ctrl_Reg at 0x000 defines n. A write outputs the value to afreadym."]
...
#[doc = "Field `ATBYTES` reader - A read returns the value of the atbytess\\[n\\] signal, where the value of the Ctrl_Reg at 0x000 defines n. A write outputs the value to atbytesm."]
...
#[doc = "Field `ATBYTES` writer - A read returns the value of the atbytess\\[n\\] signal, where the value of the Ctrl_Reg at 0x000 defines n. A write outputs the value to atbytesm."]
...
impl R {
    #[doc = "Bit 0 - A read returns the value of the atvalids\\[n\\] signal, where the value of the CTRLREG at 0x000 defines n. A write outputs the value to atvalidm."]
    #[inline(always)]
    pub fn atvalid(&self) -> AtvalidR {
        AtvalidR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 2 - A read returns the value of the afreadys\\[n\\] signal, where the value of the Ctrl_Reg at 0x000 defines n. A write outputs the value to afreadym."]
    #[inline(always)]
    pub fn afready(&self) -> AfreadyR {
        AfreadyR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 8:9 - A read returns the value of the atbytess\\[n\\] signal, where the value of the Ctrl_Reg at 0x000 defines n. A write outputs the value to atbytesm."]
    #[inline(always)]
