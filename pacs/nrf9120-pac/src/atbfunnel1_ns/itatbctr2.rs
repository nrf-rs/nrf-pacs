...
#[doc = "Field `ATREADY` reader - A read access returns the value of atreadym. A write access outputs the data to afvalids\\[n\\], where the value of the CTRLREG at 0x000 defines n."]
...
#[doc = "Field `ATREADY` writer - A read access returns the value of atreadym. A write access outputs the data to afvalids\\[n\\], where the value of the CTRLREG at 0x000 defines n."]
...
#[doc = "Field `AFVALID` reader - A read access returns the value of afvalidm. A write access outputs the data to atreadys\\[n\\], where the value of the CTRLREG at 0x000 defines n."]
...
#[doc = "Field `AFVALID` writer - A read access returns the value of afvalidm. A write access outputs the data to atreadys\\[n\\], where the value of the CTRLREG at 0x000 defines n."]
...
impl R {
    #[doc = "Bit 0 - A read access returns the value of atreadym. A write access outputs the data to afvalids\\[n\\], where the value of the CTRLREG at 0x000 defines n."]
    #[inline(always)]
    pub fn atready(&self) -> AtreadyR {
        AtreadyR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - A read access returns the value of afvalidm. A write access outputs the data to atreadys\\[n\\], where the value of the CTRLREG at 0x000 defines n."]
    #[inline(always)]
