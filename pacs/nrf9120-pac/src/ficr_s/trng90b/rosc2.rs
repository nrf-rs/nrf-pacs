...
#[doc = "Field `ROSC2` reader - Sample count for ring oscillator configuration 2"]
pub type Rosc2R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Sample count for ring oscillator configuration 2"]
    #[inline(always)]
    pub fn rosc2(&self) -> Rosc2R {
        Rosc2R::new(self.bits)
    }
}
#[doc = "Sample count for ring oscillator configuration 2\n\nYou can [`read`](crate::Reg::read) this register and get [`rosc2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
