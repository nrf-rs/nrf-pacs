...
#[doc = "SUBSCRIBE_SEQSTART (rw) register accessor: Description collection: Subscribe configuration for task SEQSTART\\[n\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_seqstart::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_seqstart::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@subscribe_seqstart`] module"]
