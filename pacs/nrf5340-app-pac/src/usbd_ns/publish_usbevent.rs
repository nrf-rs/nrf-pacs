...
impl From<crate::R<PUBLISH_USBEVENT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PUBLISH_USBEVENT_SPEC>> for W {
    #[inline(always)]
...
pub type CHIDX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PUBLISH_USBEVENT_SPEC, u8, u8, 8, O>;
#[doc = "Field `EN` reader - "]
...
#[doc = "Field `EN` writer - "]
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PUBLISH_USBEVENT_SPEC, EN_A, O>;
