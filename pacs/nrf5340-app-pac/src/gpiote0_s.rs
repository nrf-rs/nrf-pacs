...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn publish_port(&self) -> &PublishPort {
        &self.publish_port
    }
...
pub mod publish_in;
#[doc = "PUBLISH_PORT (rw) register accessor: Publish configuration for event PORT\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_port::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_port::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@publish_port`] module"]
#[doc(alias = "PUBLISH_PORT")]
pub type PublishPort = crate::Reg<publish_port::PublishPortSpec>;
...
pub mod intenclr;
#[doc = "LATENCY (rw) register accessor: Latency selection for Event mode (MODE=Event) with rising or falling edge detection on the pin.\n\nYou can [`read`](crate::Reg::read) this register and get [`latency::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`latency::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@latency`] module"]
#[doc(alias = "LATENCY")]
pub type Latency = crate::Reg<latency::LatencySpec>;
