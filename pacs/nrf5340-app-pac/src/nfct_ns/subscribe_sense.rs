...
pub type R = crate::R<SubscribeSenseSpec>;
#[doc = "Register `SUBSCRIBE_SENSE` writer"]
pub type W = crate::W<SubscribeSenseSpec>;
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that task SENSE will subscribe to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, SubscribeSenseSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, SubscribeSenseSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Subscribe configuration for task SENSE\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_sense::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_sense::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SubscribeSenseSpec;
impl crate::RegisterSpec for SubscribeSenseSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`subscribe_sense::R`](R) reader structure"]
impl crate::Readable for SubscribeSenseSpec {}
#[doc = "`write(|w| ..)` method takes [`subscribe_sense::W`](W) writer structure"]
impl crate::Writable for SubscribeSenseSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SUBSCRIBE_SENSE to value 0"]
impl crate::Resettable for SubscribeSenseSpec {}
