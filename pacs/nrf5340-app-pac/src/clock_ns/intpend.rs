...
impl HfclkaudiostartedR {
    ...
    pub const fn variant(&self) -> Hfclkaudiostarted {
        match self.bits {
            false => Hfclkaudiostarted::NotPending,
            true => Hfclkaudiostarted::Pending,
        }
    }
    #[doc = "Read: Not pending"]
    #[inline(always)]
    pub fn is_not_pending(&self) -> bool {
        *self == Hfclkaudiostarted::NotPending
    }
    #[doc = "Read: Pending"]
    #[inline(always)]
    pub fn is_pending(&self) -> bool {
        *self == Hfclkaudiostarted::Pending
    }
}
...
impl Hfclk192mstartedR {
    ...
    pub const fn variant(&self) -> Hfclk192mstarted {
        match self.bits {
            false => Hfclk192mstarted::NotPending,
            true => Hfclk192mstarted::Pending,
        }
    }
    #[doc = "Read: Not pending"]
    #[inline(always)]
    pub fn is_not_pending(&self) -> bool {
        *self == Hfclk192mstarted::NotPending
    }
    #[doc = "Read: Pending"]
    #[inline(always)]
    pub fn is_pending(&self) -> bool {
        *self == Hfclk192mstarted::Pending
    }
}
impl R {
