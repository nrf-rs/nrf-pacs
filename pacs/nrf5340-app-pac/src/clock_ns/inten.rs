...
pub type HfclkaudiostartedW<'a, REG> = crate::BitWriter<'a, REG, Hfclkaudiostarted>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Hfclkaudiostarted::Disabled)
    }
    #[doc = "Enable"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Hfclkaudiostarted::Enabled)
    }
}
...
pub type Hfclk192mstartedW<'a, REG> = crate::BitWriter<'a, REG, Hfclk192mstarted>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Hfclk192mstarted::Disabled)
    }
    #[doc = "Enable"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Hfclk192mstarted::Enabled)
    }
}
impl R {
...
impl W {
    ...
    #[doc = "Bit 8 - Enable or disable interrupt for event HFCLKAUDIOSTARTED"]
    #[inline(always)]
    pub fn hfclkaudiostarted(&mut self) -> HfclkaudiostartedW<'_, IntenSpec> {
        HfclkaudiostartedW::new(self, 8)
    }
    #[doc = "Bit 9 - Enable or disable interrupt for event HFCLK192MSTARTED"]
    #[inline(always)]
    pub fn hfclk192mstarted(&mut self) -> Hfclk192mstartedW<'_, IntenSpec> {
