...
pub type R = crate::R<HfclkaudioalwaysrunSpec>;
#[doc = "Register `HFCLKAUDIOALWAYSRUN` writer"]
pub type W = crate::W<HfclkaudioalwaysrunSpec>;
...
impl W {
    #[doc = "Bit 0 - Ensure clock is always running"]
    #[inline(always)]
    pub fn alwaysrun(&mut self) -> AlwaysrunW<'_, HfclkaudioalwaysrunSpec> {
        AlwaysrunW::new(self, 0)
    }
}
#[doc = "Automatic or manual control of HFCLKAUDIO\n\nYou can [`read`](crate::Reg::read) this register and get [`hfclkaudioalwaysrun::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hfclkaudioalwaysrun::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HfclkaudioalwaysrunSpec;
impl crate::RegisterSpec for HfclkaudioalwaysrunSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfclkaudioalwaysrun::R`](R) reader structure"]
impl crate::Readable for HfclkaudioalwaysrunSpec {}
#[doc = "`write(|w| ..)` method takes [`hfclkaudioalwaysrun::W`](W) writer structure"]
impl crate::Writable for HfclkaudioalwaysrunSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HFCLKAUDIOALWAYSRUN to value 0"]
impl crate::Resettable for HfclkaudioalwaysrunSpec {}
