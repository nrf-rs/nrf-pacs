...
pub type R = crate::R<Hfclk192mrunSpec>;
...
#[doc = "Status indicating that HFCLK192MSTART task has been triggered\n\nYou can [`read`](crate::Reg::read) this register and get [`hfclk192mrun::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfclk192mrunSpec;
impl crate::RegisterSpec for Hfclk192mrunSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfclk192mrun::R`](R) reader structure"]
impl crate::Readable for Hfclk192mrunSpec {}
#[doc = "`reset()` method sets HFCLK192MRUN to value 0"]
impl crate::Resettable for Hfclk192mrunSpec {}
