    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(HfclkaudiostartedWO::Set)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(Hfclk192mstartedWO::Set)
    }
}
impl R {
...
impl W {
    ...
    #[doc = "Bit 8 - Write '1' to enable interrupt for event HFCLKAUDIOSTARTED"]
    #[inline(always)]
    pub fn hfclkaudiostarted(&mut self) -> HfclkaudiostartedW<'_, IntensetSpec> {
        HfclkaudiostartedW::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to enable interrupt for event HFCLK192MSTARTED"]
    #[inline(always)]
    pub fn hfclk192mstarted(&mut self) -> Hfclk192mstartedW<'_, IntensetSpec> {
