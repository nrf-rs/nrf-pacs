...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IO1_SPEC, u8, u8, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader<bool>;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO1_SPEC, bool, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO1_SPEC, CONNECT_A, O>;
