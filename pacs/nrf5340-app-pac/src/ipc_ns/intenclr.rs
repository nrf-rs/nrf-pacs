    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Receive10WO::Clear)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Receive11WO::Clear)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Receive12WO::Clear)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Receive13WO::Clear)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Receive14WO::Clear)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Receive15WO::Clear)
    }
}
impl R {
...
impl W {
    #[doc = "Bit 0 - Write '1' to disable interrupt for event RECEIVE\\[0\\]"]
    #[inline(always)]
    pub fn receive0(&mut self) -> Receive0W<'_, IntenclrSpec> {
        Receive0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event RECEIVE\\[1\\]"]
    #[inline(always)]
    pub fn receive1(&mut self) -> Receive1W<'_, IntenclrSpec> {
        Receive1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event RECEIVE\\[2\\]"]
    #[inline(always)]
    pub fn receive2(&mut self) -> Receive2W<'_, IntenclrSpec> {
        Receive2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event RECEIVE\\[3\\]"]
    #[inline(always)]
    pub fn receive3(&mut self) -> Receive3W<'_, IntenclrSpec> {
        Receive3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event RECEIVE\\[4\\]"]
    #[inline(always)]
    pub fn receive4(&mut self) -> Receive4W<'_, IntenclrSpec> {
        Receive4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event RECEIVE\\[5\\]"]
    #[inline(always)]
    pub fn receive5(&mut self) -> Receive5W<'_, IntenclrSpec> {
        Receive5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to disable interrupt for event RECEIVE\\[6\\]"]
    #[inline(always)]
    pub fn receive6(&mut self) -> Receive6W<'_, IntenclrSpec> {
        Receive6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to disable interrupt for event RECEIVE\\[7\\]"]
    #[inline(always)]
    pub fn receive7(&mut self) -> Receive7W<'_, IntenclrSpec> {
        Receive7W::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to disable interrupt for event RECEIVE\\[8\\]"]
    #[inline(always)]
    pub fn receive8(&mut self) -> Receive8W<'_, IntenclrSpec> {
        Receive8W::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to disable interrupt for event RECEIVE\\[9\\]"]
    #[inline(always)]
    pub fn receive9(&mut self) -> Receive9W<'_, IntenclrSpec> {
        Receive9W::new(self, 9)
    }
    #[doc = "Bit 10 - Write '1' to disable interrupt for event RECEIVE\\[10\\]"]
    #[inline(always)]
    pub fn receive10(&mut self) -> Receive10W<'_, IntenclrSpec> {
        Receive10W::new(self, 10)
    }
    #[doc = "Bit 11 - Write '1' to disable interrupt for event RECEIVE\\[11\\]"]
    #[inline(always)]
    pub fn receive11(&mut self) -> Receive11W<'_, IntenclrSpec> {
        Receive11W::new(self, 11)
    }
    #[doc = "Bit 12 - Write '1' to disable interrupt for event RECEIVE\\[12\\]"]
    #[inline(always)]
    pub fn receive12(&mut self) -> Receive12W<'_, IntenclrSpec> {
        Receive12W::new(self, 12)
    }
    #[doc = "Bit 13 - Write '1' to disable interrupt for event RECEIVE\\[13\\]"]
    #[inline(always)]
    pub fn receive13(&mut self) -> Receive13W<'_, IntenclrSpec> {
        Receive13W::new(self, 13)
    }
    #[doc = "Bit 14 - Write '1' to disable interrupt for event RECEIVE\\[14\\]"]
    #[inline(always)]
    pub fn receive14(&mut self) -> Receive14W<'_, IntenclrSpec> {
        Receive14W::new(self, 14)
    }
    #[doc = "Bit 15 - Write '1' to disable interrupt for event RECEIVE\\[15\\]"]
    #[inline(always)]
    pub fn receive15(&mut self) -> Receive15W<'_, IntenclrSpec> {
