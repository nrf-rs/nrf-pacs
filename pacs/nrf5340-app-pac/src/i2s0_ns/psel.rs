#[doc = "MCK register accessor: an alias for `Reg<MCK_SPEC>`"]
...
pub mod sck;
#[doc = "LRCK register accessor: an alias for `Reg<LRCK_SPEC>`"]
pub type LRCK = crate::Reg<lrck::LRCK_SPEC>;
#[doc = "Pin select for LRCK signal"]
pub mod lrck;
#[doc = "SDIN register accessor: an alias for `Reg<SDIN_SPEC>`"]
pub type SDIN = crate::Reg<sdin::SDIN_SPEC>;
#[doc = "Pin select for SDIN signal"]
pub mod sdin;
#[doc = "SDOUT register accessor: an alias for `Reg<SDOUT_SPEC>`"]
