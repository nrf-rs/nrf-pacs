...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn mclkconfig(&self) -> &Mclkconfig {
        &self.mclkconfig
    }
...
#[doc = "Unspecified"]
pub mod psel;
#[doc = "MCLKCONFIG (rw) register accessor: Master clock generator configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`mclkconfig::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mclkconfig::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mclkconfig`] module"]
#[doc(alias = "MCLKCONFIG")]
pub type Mclkconfig = crate::Reg<mclkconfig::MclkconfigSpec>;
