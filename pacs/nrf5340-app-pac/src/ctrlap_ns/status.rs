...
impl From<Uicrsecureapprotect> for bool {
    #[inline(always)]
    fn from(variant: Uicrsecureapprotect) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `UICRSECUREAPPROTECT` reader - Status bit for UICR part of secure access port protection at last reset."]
pub type UicrsecureapprotectR = crate::BitReader<Uicrsecureapprotect>;
impl UicrsecureapprotectR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uicrsecureapprotect {
        match self.bits {
            false => Uicrsecureapprotect::Enabled,
            true => Uicrsecureapprotect::Disabled,
        }
    }
    #[doc = "SECUREAPPROTECT was enabled in UICR"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == Uicrsecureapprotect::Enabled
    }
    #[doc = "SECUREAPPROTECT was disabled in UICR"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Uicrsecureapprotect::Disabled
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn uicrsecureapprotect(&self) -> UicrsecureapprotectR {
        UicrsecureapprotectR::new(((self.bits >> 1) & 1) != 0)
    }
