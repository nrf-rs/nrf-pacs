...
impl HfxocntR {
    ...
    pub const fn variant(&self) -> Option<Hfxocnt> {
        match self.bits {
            ...
            254 => Some(Hfxocnt::MaxDebounceTime),
            255 => Some(Hfxocnt::DefaultDebounceTime),
            _ => None,
        }
    }
    ...
    pub fn is_default_debounce_time(&self) -> bool {
        *self == Hfxocnt::DefaultDebounceTime
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Default debounce time for erased UICR = 4*64 us + 0.5 us"]
    #[inline(always)]
    pub fn default_debounce_time(self) -> &'a mut crate::W<REG> {
        self.variant(Hfxocnt::DefaultDebounceTime)
    }
}
impl R {
...
impl W {
    #[doc = "Bits 0:7 - HFXO startup counter. Total debounce time = HFXOCNT*64 us + 0.5 us"]
    #[inline(always)]
    pub fn hfxocnt(&mut self) -> HfxocntW<'_, HfxocntSpec> {
        HfxocntW::new(self, 0)
    }
}
#[doc = "HFXO startup counter\n\nYou can [`read`](crate::Reg::read) this register and get [`hfxocnt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hfxocnt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
