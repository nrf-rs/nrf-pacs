...
#[doc = "SUBSCRIBE_READCLRACC (rw) register accessor: an alias for `Reg<SUBSCRIBE_READCLRACC_SPEC>`"]
...
#[doc = "SUBSCRIBE_RDCLRACC (rw) register accessor: an alias for `Reg<SUBSCRIBE_RDCLRACC_SPEC>`"]
...
#[doc = "SUBSCRIBE_RDCLRDBL (rw) register accessor: an alias for `Reg<SUBSCRIBE_RDCLRDBL_SPEC>`"]
...
#[doc = "PUBLISH_SAMPLERDY (rw) register accessor: an alias for `Reg<PUBLISH_SAMPLERDY_SPEC>`"]
...
#[doc = "PUBLISH_REPORTRDY (rw) register accessor: an alias for `Reg<PUBLISH_REPORTRDY_SPEC>`"]
...
#[doc = "PUBLISH_ACCOF (rw) register accessor: an alias for `Reg<PUBLISH_ACCOF_SPEC>`"]
...
#[doc = "PUBLISH_DBLRDY (rw) register accessor: an alias for `Reg<PUBLISH_DBLRDY_SPEC>`"]
