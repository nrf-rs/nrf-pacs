...
pub type INVALIDOPERATION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTENCLR_SPEC, INVALIDOPERATION_AW, O>;
...
pub type DIVIDEBYZERO_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTENCLR_SPEC, DIVIDEBYZERO_AW, O>;
...
pub type OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, OVERFLOW_AW, O>;
...
pub type UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, UNDERFLOW_AW, O>;
...
pub type INEXACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, INEXACT_AW, O>;
...
pub type DENORMALINPUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTENCLR_SPEC, DENORMALINPUT_AW, O>;
