...
impl W {
    #[doc = "Bit 0 - Key slot has been revoked and cannot be tasked for selection"]
    #[inline(always)]
    pub fn events_keyslot_revoked(
        &mut self,
    ) -> EventsKeyslotRevokedW<'_, EventsKeyslotRevokedSpec> {
        EventsKeyslotRevokedW::new(self, 0)
    }
}
#[doc = "Key slot has been revoked and cannot be tasked for selection\n\nYou can [`read`](crate::Reg::read) this register and get [`events_keyslot_revoked::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`events_keyslot_revoked::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
