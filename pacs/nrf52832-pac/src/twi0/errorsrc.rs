...
pub type OverrunW<'a, REG> = crate::BitWriter1C<'a, REG, OverrunWO>;
...
pub type AnackW<'a, REG> = crate::BitWriter1C<'a, REG, AnackWO>;
...
pub type DnackW<'a, REG> = crate::BitWriter1C<'a, REG, DnackWO>;
