...
pub type PinW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Connection\n\nValue on reset: 1"]
...
impl W {
    #[doc = "Bits 0:5 - GPIO number P0.n onto which Reset is exposed"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<'_, PselresetSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<'_, PselresetSpec> {
...
#[doc = "`reset()` method sets PSELRESET[%s] to value 0xffff_ffff"]
