...
impl RegisterBlock {
    ...
    #[doc = "0x40..0x58 - Description collection\\[0\\]: Capture Timer value to CC\\[0\\] register"]
    #[inline(always)]
    ...
    #[doc = "0x140..0x158 - Description collection\\[0\\]: Compare event on CC\\[0\\] match"]
    #[inline(always)]
    ...
    #[doc = "0x540..0x558 - Description collection\\[0\\]: Capture/Compare register 0"]
    #[inline(always)]
