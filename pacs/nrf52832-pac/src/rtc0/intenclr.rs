...
#[doc = "Field `TICK` reader - Write '1' to Disable interrupt for TICK event"]
...
#[doc = "Field `TICK` writer - Write '1' to Disable interrupt for TICK event"]
...
#[doc = "Field `OVRFLW` reader - Write '1' to Disable interrupt for OVRFLW event"]
...
#[doc = "Field `OVRFLW` writer - Write '1' to Disable interrupt for OVRFLW event"]
...
impl R {
    #[doc = "Bit 0 - Write '1' to Disable interrupt for TICK event"]
    #[inline(always)]
    pub fn tick(&self) -> TickR {
        TickR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Write '1' to Disable interrupt for OVRFLW event"]
    #[inline(always)]
