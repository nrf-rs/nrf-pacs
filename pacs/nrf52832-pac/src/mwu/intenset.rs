...
impl W {
    #[doc = "Bit 0 - Write '1' to Enable interrupt for REGION\\[0\\].WA event"]
    #[inline(always)]
    pub fn region0wa(&mut self) -> Region0waW<'_, IntensetSpec> {
        Region0waW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to Enable interrupt for REGION\\[0\\].RA event"]
    #[inline(always)]
    pub fn region0ra(&mut self) -> Region0raW<'_, IntensetSpec> {
        Region0raW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to Enable interrupt for REGION\\[1\\].WA event"]
    #[inline(always)]
    pub fn region1wa(&mut self) -> Region1waW<'_, IntensetSpec> {
        Region1waW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to Enable interrupt for REGION\\[1\\].RA event"]
    #[inline(always)]
    pub fn region1ra(&mut self) -> Region1raW<'_, IntensetSpec> {
        Region1raW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to Enable interrupt for REGION\\[2\\].WA event"]
    #[inline(always)]
    pub fn region2wa(&mut self) -> Region2waW<'_, IntensetSpec> {
        Region2waW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to Enable interrupt for REGION\\[2\\].RA event"]
    #[inline(always)]
    pub fn region2ra(&mut self) -> Region2raW<'_, IntensetSpec> {
        Region2raW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to Enable interrupt for REGION\\[3\\].WA event"]
    #[inline(always)]
    pub fn region3wa(&mut self) -> Region3waW<'_, IntensetSpec> {
        Region3waW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to Enable interrupt for REGION\\[3\\].RA event"]
    #[inline(always)]
    pub fn region3ra(&mut self) -> Region3raW<'_, IntensetSpec> {
        Region3raW::new(self, 7)
    }
    #[doc = "Bit 24 - Write '1' to Enable interrupt for PREGION\\[0\\].WA event"]
    #[inline(always)]
    pub fn pregion0wa(&mut self) -> Pregion0waW<'_, IntensetSpec> {
        Pregion0waW::new(self, 24)
    }
    #[doc = "Bit 25 - Write '1' to Enable interrupt for PREGION\\[0\\].RA event"]
    #[inline(always)]
    pub fn pregion0ra(&mut self) -> Pregion0raW<'_, IntensetSpec> {
        Pregion0raW::new(self, 25)
    }
    #[doc = "Bit 26 - Write '1' to Enable interrupt for PREGION\\[1\\].WA event"]
    #[inline(always)]
    pub fn pregion1wa(&mut self) -> Pregion1waW<'_, IntensetSpec> {
        Pregion1waW::new(self, 26)
    }
    #[doc = "Bit 27 - Write '1' to Enable interrupt for PREGION\\[1\\].RA event"]
    #[inline(always)]
    pub fn pregion1ra(&mut self) -> Pregion1raW<'_, IntensetSpec> {
