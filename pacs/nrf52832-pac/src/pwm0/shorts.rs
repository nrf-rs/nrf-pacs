...
#[doc = "Field `SEQEND0_STOP` reader - Shortcut between SEQEND\\[0\\] event and STOP task"]
...
#[doc = "Field `SEQEND0_STOP` writer - Shortcut between SEQEND\\[0\\] event and STOP task"]
...
#[doc = "Field `SEQEND1_STOP` reader - Shortcut between SEQEND\\[1\\] event and STOP task"]
...
#[doc = "Field `SEQEND1_STOP` writer - Shortcut between SEQEND\\[1\\] event and STOP task"]
...
#[doc = "Field `LOOPSDONE_SEQSTART0` reader - Shortcut between LOOPSDONE event and SEQSTART\\[0\\] task"]
...
#[doc = "Field `LOOPSDONE_SEQSTART0` writer - Shortcut between LOOPSDONE event and SEQSTART\\[0\\] task"]
...
#[doc = "Field `LOOPSDONE_SEQSTART1` reader - Shortcut between LOOPSDONE event and SEQSTART\\[1\\] task"]
...
#[doc = "Field `LOOPSDONE_SEQSTART1` writer - Shortcut between LOOPSDONE event and SEQSTART\\[1\\] task"]
...
impl W {
    ...
    #[doc = "Bit 2 - Shortcut between LOOPSDONE event and SEQSTART\\[0\\] task"]
    #[inline(always)]
    pub fn loopsdone_seqstart0(&mut self) -> LoopsdoneSeqstart0W<'_, ShortsSpec> {
        LoopsdoneSeqstart0W::new(self, 2)
    }
    #[doc = "Bit 3 - Shortcut between LOOPSDONE event and SEQSTART\\[1\\] task"]
    #[inline(always)]
    pub fn loopsdone_seqstart1(&mut self) -> LoopsdoneSeqstart1W<'_, ShortsSpec> {
