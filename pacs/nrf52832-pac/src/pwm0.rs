...
impl RegisterBlock {
    ...
    #[doc = "0x08..0x10 - Description collection\\[0\\]: Loads the first PWM value on all enabled channels from sequence 0, and starts playing that sequence at the rate defined in SEQ\\[0\\]REFRESH and/or DECODER.MODE. Causes PWM generation to start it was not running."]
    #[inline(always)]
    ...
    #[doc = "0x108..0x110 - Description collection\\[0\\]: First PWM period started on sequence 0"]
    #[inline(always)]
    ...
    #[doc = "0x110..0x118 - Description collection\\[0\\]: Emitted at end of every sequence 0, when last value from RAM has been applied to wave counter"]
    #[inline(always)]
...
pub mod tasks_stop;
#[doc = "TASKS_SEQSTART (w) register accessor: Description collection\\[0\\]: Loads the first PWM value on all enabled channels from sequence 0, and starts playing that sequence at the rate defined in SEQ\\[0\\]REFRESH and/or DECODER.MODE. Causes PWM generation to start it was not running.\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tasks_seqstart::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tasks_seqstart`] module"]
