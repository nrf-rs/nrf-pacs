...
#[doc = "Field `LASTRX` reader - Write '1' to Disable interrupt for LASTRX event"]
...
#[doc = "Field `LASTRX` writer - Write '1' to Disable interrupt for LASTRX event"]
...
#[doc = "Field `LASTTX` reader - Write '1' to Disable interrupt for LASTTX event"]
...
#[doc = "Field `LASTTX` writer - Write '1' to Disable interrupt for LASTTX event"]
