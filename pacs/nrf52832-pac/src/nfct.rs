...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn currentloadctrl(&self) -> &Currentloadctrl {
        &self.currentloadctrl
    }
...
#[doc = "Unspecified"]
pub mod framestatus;
#[doc = "CURRENTLOADCTRL (r) register accessor: Current value driven to the NFC Load Control\n\nYou can [`read`](crate::Reg::read) this register and get [`currentloadctrl::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@currentloadctrl`] module"]
#[doc(alias = "CURRENTLOADCTRL")]
pub type Currentloadctrl = crate::Reg<currentloadctrl::CurrentloadctrlSpec>;
