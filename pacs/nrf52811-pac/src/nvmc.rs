...
pub mod eraseuicr;
#[doc = "ERASEPAGEPARTIAL (rw) register accessor: Register for partial erase of a page in code area\n\nYou can [`read`](crate::Reg::read) this register and get [`erasepagepartial::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`erasepagepartial::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@erasepagepartial`] module"]
