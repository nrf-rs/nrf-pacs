...
#[doc = "Field `EVENTS_PHYEND` reader - Generated when last bit is sent on air"]
...
#[doc = "Field `EVENTS_PHYEND` writer - Generated when last bit is sent on air"]
pub type EVENTS_PHYEND_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVENTS_PHYEND_SPEC, EVENTS_PHYEND_A, O>;
