...
pub type R = crate::R<ErasepagepartialSpec>;
...
pub type ErasepagepartialR = crate::FieldReader<u32>;
...
impl R {
    ...
    #[inline(always)]
    pub fn erasepagepartial(&self) -> ErasepagepartialR {
        ErasepagepartialR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Register for starting partial erase of a page in code area"]
...
#[doc = "Register for partial erase of a page in code area\n\nYou can [`read`](crate::Reg::read) this register and get [`erasepagepartial::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`erasepagepartial::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
impl crate::Readable for ErasepagepartialSpec {}
