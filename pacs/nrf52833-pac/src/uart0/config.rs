...
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_SPEC, STOP_A, O>;
...
pub type PARITYTYPE_R = crate::BitReader<PARITYTYPE_A>;
...
pub type PARITYTYPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_SPEC, PARITYTYPE_A, O>;
impl<'a, const O: u8> PARITYTYPE_W<'a, O> {
    #[doc = "Even parity"]
    #[inline(always)]
...
impl R {
    ...
    pub fn paritytype(&self) -> PARITYTYPE_R {
        PARITYTYPE_R::new(((self.bits >> 8) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Hardware flow control"]
    ...
    #[doc = "Bit 8 - Even or odd parity type"]
    #[inline(always)]
    pub fn paritytype(&mut self) -> PARITYTYPE_W<8> {
        PARITYTYPE_W::new(self)
    }
