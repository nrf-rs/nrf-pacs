...
pub type SYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENSET_SPEC, SYNC_AW, O>;
...
pub type CTEPRESENT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENSET_SPEC, CTEPRESENT_AW, O>;
