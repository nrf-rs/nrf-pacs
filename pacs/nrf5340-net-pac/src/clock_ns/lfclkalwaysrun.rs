...
pub type R = crate::R<LfclkalwaysrunSpec>;
#[doc = "Register `LFCLKALWAYSRUN` writer"]
pub type W = crate::W<LfclkalwaysrunSpec>;
...
impl W {
    #[doc = "Bit 0 - Ensure clock is always running"]
    #[inline(always)]
    pub fn alwaysrun(&mut self) -> AlwaysrunW<'_, LfclkalwaysrunSpec> {
        AlwaysrunW::new(self, 0)
    }
}
#[doc = "Automatic or manual control of LFCLK\n\nYou can [`read`](crate::Reg::read) this register and get [`lfclkalwaysrun::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lfclkalwaysrun::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfclkalwaysrunSpec;
impl crate::RegisterSpec for LfclkalwaysrunSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfclkalwaysrun::R`](R) reader structure"]
impl crate::Readable for LfclkalwaysrunSpec {}
#[doc = "`write(|w| ..)` method takes [`lfclkalwaysrun::W`](W) writer structure"]
impl crate::Writable for LfclkalwaysrunSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LFCLKALWAYSRUN to value 0"]
impl crate::Resettable for LfclkalwaysrunSpec {}
