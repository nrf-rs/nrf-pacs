...
pub type R = crate::R<SubscribeRssistopSpec>;
#[doc = "Register `SUBSCRIBE_RSSISTOP` writer"]
pub type W = crate::W<SubscribeRssistopSpec>;
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that task RSSISTOP will subscribe to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, SubscribeRssistopSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, SubscribeRssistopSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Subscribe configuration for task RSSISTOP\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_rssistop::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_rssistop::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SubscribeRssistopSpec;
impl crate::RegisterSpec for SubscribeRssistopSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`subscribe_rssistop::R`](R) reader structure"]
impl crate::Readable for SubscribeRssistopSpec {}
#[doc = "`write(|w| ..)` method takes [`subscribe_rssistop::W`](W) writer structure"]
impl crate::Writable for SubscribeRssistopSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SUBSCRIBE_RSSISTOP to value 0"]
impl crate::Resettable for SubscribeRssistopSpec {}
