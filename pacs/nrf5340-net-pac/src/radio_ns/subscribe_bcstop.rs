...
pub type R = crate::R<SubscribeBcstopSpec>;
#[doc = "Register `SUBSCRIBE_BCSTOP` writer"]
pub type W = crate::W<SubscribeBcstopSpec>;
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that task BCSTOP will subscribe to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, SubscribeBcstopSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, SubscribeBcstopSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Subscribe configuration for task BCSTOP\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_bcstop::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_bcstop::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SubscribeBcstopSpec;
impl crate::RegisterSpec for SubscribeBcstopSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`subscribe_bcstop::R`](R) reader structure"]
impl crate::Readable for SubscribeBcstopSpec {}
#[doc = "`write(|w| ..)` method takes [`subscribe_bcstop::W`](W) writer structure"]
impl crate::Writable for SubscribeBcstopSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SUBSCRIBE_BCSTOP to value 0"]
impl crate::Resettable for SubscribeBcstopSpec {}
