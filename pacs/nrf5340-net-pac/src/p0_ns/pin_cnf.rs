...
impl DriveR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Drive> {
        match self.bits {
            0 => Some(Drive::S0s1),
            1 => Some(Drive::H0s1),
            2 => Some(Drive::S0h1),
...
pub type DriveW<'a, REG> = crate::FieldWriter<'a, REG, 4, Drive>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Extra high drive '0', extra high drive '1'"]
    #[inline(always)]
    pub fn e0e1(self) -> &'a mut crate::W<REG> {
        self.variant(Drive::E0e1)
    }
}
...
impl From<Mcusel> for u8 {
    #[inline(always)]
    fn from(variant: Mcusel) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Mcusel {
    type Ux = u8;
}
impl crate::IsEnum for Mcusel {}
#[doc = "Field `MCUSEL` reader - Select which MCU/Subsystem controls this pin Note: this field is only accessible from secure code."]
pub type McuselR = crate::FieldReader<Mcusel>;
impl McuselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Mcusel> {
        match self.bits {
            0 => Some(Mcusel::AppMcu),
            1 => Some(Mcusel::NetworkMcu),
            3 => Some(Mcusel::Peripheral),
            7 => Some(Mcusel::Tnd),
            _ => None,
        }
    }
    ...
    pub fn is_network_mcu(&self) -> bool {
        *self == Mcusel::NetworkMcu
    }
    #[doc = "Peripheral with dedicated pins"]
    #[inline(always)]
    pub fn is_peripheral(&self) -> bool {
        *self == Mcusel::Peripheral
    }
...
pub type McuselW<'a, REG> = crate::FieldWriter<'a, REG, 3, Mcusel>;
impl<'a, REG> McuselW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "Application MCU"]
    #[inline(always)]
    pub fn app_mcu(self) -> &'a mut crate::W<REG> {
        self.variant(Mcusel::AppMcu)
    }
    #[doc = "Network MCU"]
    #[inline(always)]
    pub fn network_mcu(self) -> &'a mut crate::W<REG> {
        self.variant(Mcusel::NetworkMcu)
    }
    #[doc = "Peripheral with dedicated pins"]
    #[inline(always)]
    pub fn peripheral(self) -> &'a mut crate::W<REG> {
        self.variant(Mcusel::Peripheral)
    }
    #[doc = "Trace and Debug Subsystem"]
    #[inline(always)]
    pub fn tnd(self) -> &'a mut crate::W<REG> {
        self.variant(Mcusel::Tnd)
    }
}
impl R {
    ...
    pub fn drive(&self) -> DriveR {
        DriveR::new(((self.bits >> 8) & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn mcusel(&self) -> McuselR {
        McuselR::new(((self.bits >> 28) & 7) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Pin direction. Same physical register as DIR register"]
    ...
    #[doc = "Bits 8:11 - Drive configuration"]
    #[inline(always)]
    pub fn drive(&mut self) -> DriveW<'_, PinCnfSpec> {
        DriveW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Pin sensing mechanism"]
    #[inline(always)]
    ...
    #[doc = "Bits 28:30 - Select which MCU/Subsystem controls this pin Note: this field is only accessible from secure code."]
    #[inline(always)]
    pub fn mcusel(&mut self) -> McuselW<'_, PinCnfSpec> {
        McuselW::new(self, 28)
    }
}
