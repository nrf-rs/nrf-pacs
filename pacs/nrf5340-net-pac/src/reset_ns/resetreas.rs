...
pub type LSREQ_R = crate::BitReader<LSREQ_A>;
...
pub type LSREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESETREAS_SPEC, LSREQ_A, O>;
impl<'a, const O: u8> LSREQ_W<'a, O> {
    #[doc = "Not detected"]
    #[inline(always)]
    pub fn not_detected(self) -> &'a mut W {
        self.variant(LSREQ_A::NOT_DETECTED)
    }
    #[doc = "Detected"]
    #[inline(always)]
    pub fn detected(self) -> &'a mut W {
...
pub type LLOCKUP_R = crate::BitReader<LLOCKUP_A>;
...
pub type LLOCKUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESETREAS_SPEC, LLOCKUP_A, O>;
impl<'a, const O: u8> LLOCKUP_W<'a, O> {
    #[doc = "Not detected"]
    #[inline(always)]
    pub fn not_detected(self) -> &'a mut W {
        self.variant(LLOCKUP_A::NOT_DETECTED)
    }
    #[doc = "Detected"]
    #[inline(always)]
    pub fn detected(self) -> &'a mut W {
...
pub type LDOG_R = crate::BitReader<LDOG_A>;
...
pub type LDOG_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESETREAS_SPEC, LDOG_A, O>;
impl<'a, const O: u8> LDOG_W<'a, O> {
    #[doc = "Not detected"]
    #[inline(always)]
    pub fn not_detected(self) -> &'a mut W {
        self.variant(LDOG_A::NOT_DETECTED)
    }
    #[doc = "Detected"]
    #[inline(always)]
    pub fn detected(self) -> &'a mut W {
...
pub type MFORCEOFF_R = crate::BitReader<MFORCEOFF_A>;
...
impl MFORCEOFF_R {
    ...
    pub fn variant(&self) -> MFORCEOFF_A {
        match self.bits {
            false => MFORCEOFF_A::NOT_DETECTED,
...
pub type MFORCEOFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESETREAS_SPEC, MFORCEOFF_A, O>;
impl<'a, const O: u8> MFORCEOFF_W<'a, O> {
    #[doc = "Not detected"]
    #[inline(always)]
    pub fn not_detected(self) -> &'a mut W {
        self.variant(MFORCEOFF_A::NOT_DETECTED)
    }
    #[doc = "Detected"]
    #[inline(always)]
    pub fn detected(self) -> &'a mut W {
...
pub type LCTRLAP_R = crate::BitReader<LCTRLAP_A>;
...
pub type LCTRLAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESETREAS_SPEC, LCTRLAP_A, O>;
impl<'a, const O: u8> LCTRLAP_W<'a, O> {
    #[doc = "Not detected"]
    #[inline(always)]
    pub fn not_detected(self) -> &'a mut W {
        self.variant(LCTRLAP_A::NOT_DETECTED)
    }
    #[doc = "Detected"]
    #[inline(always)]
    pub fn detected(self) -> &'a mut W {
...
impl R {
    ...
    pub fn lctrlap(&self) -> LCTRLAP_R {
        LCTRLAP_R::new(((self.bits >> 27) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Reset from pin reset detected"]
    ...
    #[doc = "Bit 16 - Reset from network soft reset detected"]
    #[inline(always)]
    pub fn lsreq(&mut self) -> LSREQ_W<16> {
        LSREQ_W::new(self)
    }
    #[doc = "Bit 17 - Reset from network CPU lockup detected"]
    #[inline(always)]
    pub fn llockup(&mut self) -> LLOCKUP_W<17> {
        LLOCKUP_W::new(self)
    }
    #[doc = "Bit 18 - Reset from network watchdog timer detected"]
    #[inline(always)]
    pub fn ldog(&mut self) -> LDOG_W<18> {
        LDOG_W::new(self)
    }
    #[doc = "Bit 23 - Force-OFF reset from application core detected"]
    #[inline(always)]
    pub fn mforceoff(&mut self) -> MFORCEOFF_W<23> {
        MFORCEOFF_W::new(self)
    }
    #[doc = "Bit 24 - Reset after wakeup from System OFF mode due to NFC field being detected"]
    #[inline(always)]
    ...
    #[doc = "Bit 27 - Reset from network CTRL-AP detected"]
    #[inline(always)]
    pub fn lctrlap(&mut self) -> LCTRLAP_W<27> {
        LCTRLAP_W::new(self)
    }
