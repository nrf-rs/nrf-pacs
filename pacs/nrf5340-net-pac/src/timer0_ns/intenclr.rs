...
pub type COMPARE6_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, COMPARE6_AW, O>;
...
pub type COMPARE7_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, COMPARE7_AW, O>;
