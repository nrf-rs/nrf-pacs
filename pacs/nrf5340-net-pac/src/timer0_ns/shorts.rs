...
and task CLEAR"]
pub type COMPARE6_CLEAR_R = crate::BitReader<COMPARE6_CLEAR_A>;
...
and task CLEAR"]
pub type COMPARE6_CLEAR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SHORTS_SPEC, COMPARE6_CLEAR_A, O>;
impl<'a, const O: u8> COMPARE6_CLEAR_W<'a, O> {
    #[doc = "Disable shortcut"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
and task CLEAR"]
pub type COMPARE7_CLEAR_R = crate::BitReader<COMPARE7_CLEAR_A>;
...
and task CLEAR"]
pub type COMPARE7_CLEAR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SHORTS_SPEC, COMPARE7_CLEAR_A, O>;
impl<'a, const O: u8> COMPARE7_CLEAR_W<'a, O> {
    #[doc = "Disable shortcut"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
and task STOP"]
pub type COMPARE6_STOP_R = crate::BitReader<COMPARE6_STOP_A>;
#[doc = "Shortcut between event COMPARE\\[6\\]
and task STOP\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
and task STOP"]
pub type COMPARE6_STOP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SHORTS_SPEC, COMPARE6_STOP_A, O>;
impl<'a, const O: u8> COMPARE6_STOP_W<'a, O> {
    #[doc = "Disable shortcut"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
and task STOP"]
pub type COMPARE7_STOP_R = crate::BitReader<COMPARE7_STOP_A>;
#[doc = "Shortcut between event COMPARE\\[7\\]
and task STOP\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
and task STOP"]
pub type COMPARE7_STOP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SHORTS_SPEC, COMPARE7_STOP_A, O>;
impl<'a, const O: u8> COMPARE7_STOP_W<'a, O> {
    #[doc = "Disable shortcut"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
and task CLEAR"]
    #[inline(always)]
    pub fn compare6_clear(&mut self) -> COMPARE6_CLEAR_W<6> {
        COMPARE6_CLEAR_W::new(self)
    }
    #[doc = "Bit 7 - Shortcut between event COMPARE\\[7\\]
and task CLEAR"]
    #[inline(always)]
    pub fn compare7_clear(&mut self) -> COMPARE7_CLEAR_W<7> {
        COMPARE7_CLEAR_W::new(self)
    }
    #[doc = "Bit 16 - Shortcut between event COMPARE\\[0\\]
and task STOP"]
    #[inline(always)]
    pub fn compare0_stop(&mut self) -> COMPARE0_STOP_W<16> {
        COMPARE0_STOP_W::new(self)
    }
    #[doc = "Bit 17 - Shortcut between event COMPARE\\[1\\]
and task STOP"]
    #[inline(always)]
    pub fn compare1_stop(&mut self) -> COMPARE1_STOP_W<17> {
        COMPARE1_STOP_W::new(self)
    }
    #[doc = "Bit 18 - Shortcut between event COMPARE\\[2\\]
and task STOP"]
    #[inline(always)]
    pub fn compare2_stop(&mut self) -> COMPARE2_STOP_W<18> {
        COMPARE2_STOP_W::new(self)
    }
    #[doc = "Bit 19 - Shortcut between event COMPARE\\[3\\]
and task STOP"]
    #[inline(always)]
    pub fn compare3_stop(&mut self) -> COMPARE3_STOP_W<19> {
        COMPARE3_STOP_W::new(self)
    }
    #[doc = "Bit 20 - Shortcut between event COMPARE\\[4\\]
and task STOP"]
    #[inline(always)]
    pub fn compare4_stop(&mut self) -> COMPARE4_STOP_W<20> {
        COMPARE4_STOP_W::new(self)
    }
    #[doc = "Bit 21 - Shortcut between event COMPARE\\[5\\]
and task STOP"]
    #[inline(always)]
    pub fn compare5_stop(&mut self) -> COMPARE5_STOP_W<21> {
        COMPARE5_STOP_W::new(self)
    }
    #[doc = "Bit 22 - Shortcut between event COMPARE\\[6\\]
and task STOP"]
    #[inline(always)]
    pub fn compare6_stop(&mut self) -> COMPARE6_STOP_W<22> {
        COMPARE6_STOP_W::new(self)
    }
    #[doc = "Bit 23 - Shortcut between event COMPARE\\[7\\]
and task STOP"]
    #[inline(always)]
    pub fn compare7_stop(&mut self) -> COMPARE7_STOP_W<23> {
        COMPARE7_STOP_W::new(self)
    }
