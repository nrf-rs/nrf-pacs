...
pub struct RegisterBlock {
    tasks_send: [TasksSend; 16],
    _reserved1: [u8; 0x40],
    subscribe_send: [SubscribeSend; 16],
    _reserved2: [u8; 0x40],
    events_receive: [EventsReceive; 16],
    _reserved3: [u8; 0x40],
    publish_receive: [PublishReceive; 16],
...
pub mod intpend;
#[doc = "SEND_CNF (rw) register accessor: Description collection: Send event configuration for TASKS_SEND\\[n\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`send_cnf::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`send_cnf::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@send_cnf`] module"]
#[doc(alias = "SEND_CNF")]
pub type SendCnf = crate::Reg<send_cnf::SendCnfSpec>;
#[doc = "Description collection: Send event configuration for TASKS_SEND\\[n\\]"]
pub mod send_cnf;
#[doc = "RECEIVE_CNF (rw) register accessor: Description collection: Receive event configuration for EVENTS_RECEIVE\\[n\\]\n\nYou can [`read`](crate::Reg::read) this register and get [`receive_cnf::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`receive_cnf::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@receive_cnf`] module"]
...
pub mod receive_cnf;
#[doc = "GPMEM (rw) register accessor: Description collection: General purpose memory\n\nYou can [`read`](crate::Reg::read) this register and get [`gpmem::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpmem::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@gpmem`] module"]
#[doc(alias = "GPMEM")]
