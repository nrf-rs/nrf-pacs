...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn publish_valrdy(&self) -> &PublishValrdy {
        &self.publish_valrdy
    }
...
#[doc = "PUBLISH_VALRDY (rw) register accessor: Publish configuration for event VALRDY\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_valrdy::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_valrdy::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@publish_valrdy`] module"]
#[doc(alias = "PUBLISH_VALRDY")]
pub type PublishValrdy = crate::Reg<publish_valrdy::PublishValrdySpec>;
