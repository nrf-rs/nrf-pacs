...
pub struct RegisterBlock {
    ...
    _reserved4: [u8; 0x70],
    subscribe_ksgen: SubscribeKsgen,
    subscribe_crypt: SubscribeCrypt,
    ...
    _reserved11: [u8; 0x74],
    publish_endksgen: PublishEndksgen,
    publish_endcrypt: PublishEndcrypt,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn subscribe_ksgen(&self) -> &SubscribeKsgen {
        &self.subscribe_ksgen
    }
    #[doc = "0x84 - Subscribe configuration for task CRYPT"]
    #[inline(always)]
    pub const fn subscribe_crypt(&self) -> &SubscribeCrypt {
        &self.subscribe_crypt
    }
    ...
    #[inline(always)]
    pub const fn publish_endksgen(&self) -> &PublishEndksgen {
        &self.publish_endksgen
    }
    #[doc = "0x184 - Publish configuration for event ENDCRYPT"]
    #[inline(always)]
    pub const fn publish_endcrypt(&self) -> &PublishEndcrypt {
        &self.publish_endcrypt
    }
...
#[doc = "SUBSCRIBE_KSGEN (rw) register accessor: Subscribe configuration for task KSGEN\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_ksgen::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_ksgen::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@subscribe_ksgen`] module"]
#[doc(alias = "SUBSCRIBE_KSGEN")]
pub type SubscribeKsgen = crate::Reg<subscribe_ksgen::SubscribeKsgenSpec>;
#[doc = "Subscribe configuration for task KSGEN"]
pub mod subscribe_ksgen;
#[doc = "SUBSCRIBE_CRYPT (rw) register accessor: Subscribe configuration for task CRYPT\n\nYou can [`read`](crate::Reg::read) this register and get [`subscribe_crypt::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`subscribe_crypt::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@subscribe_crypt`] module"]
#[doc(alias = "SUBSCRIBE_CRYPT")]
pub type SubscribeCrypt = crate::Reg<subscribe_crypt::SubscribeCryptSpec>;
...
#[doc = "PUBLISH_ENDKSGEN (rw) register accessor: Publish configuration for event ENDKSGEN\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_endksgen::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_endksgen::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@publish_endksgen`] module"]
#[doc(alias = "PUBLISH_ENDKSGEN")]
pub type PublishEndksgen = crate::Reg<publish_endksgen::PublishEndksgenSpec>;
#[doc = "Publish configuration for event ENDKSGEN"]
pub mod publish_endksgen;
#[doc = "PUBLISH_ENDCRYPT (rw) register accessor: Publish configuration for event ENDCRYPT\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_endcrypt::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_endcrypt::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@publish_endcrypt`] module"]
#[doc(alias = "PUBLISH_ENDCRYPT")]
pub type PublishEndcrypt = crate::Reg<publish_endcrypt::PublishEndcryptSpec>;
#[doc = "Publish configuration for event ENDCRYPT"]
pub mod publish_endcrypt;
#[doc = "PUBLISH_ERROR (rw) register accessor: Deprecated register - Publish configuration for event ERROR\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_error::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_error::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@publish_error`] module"]
